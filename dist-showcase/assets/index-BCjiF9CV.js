import{r as h,T as es,j as e,i as S,R as be,t as ke,a as Br,b as rs}from"./theme-Cbbmiogo.js";import{a as ss,g as ts}from"./vendor-D3F3s8fL.js";(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))n(t);new MutationObserver(t=>{for(const c of t)if(c.type==="childList")for(const m of c.addedNodes)m.tagName==="LINK"&&m.rel==="modulepreload"&&n(m)}).observe(document,{childList:!0,subtree:!0});function i(t){const c={};return t.integrity&&(c.integrity=t.integrity),t.referrerPolicy&&(c.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?c.credentials="include":t.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function n(t){if(t.ep)return;t.ep=!0;const c=i(t);fetch(t.href,c)}})();var $e={},zr;function is(){if(zr)return $e;zr=1;var s=ss();return $e.createRoot=s.createRoot,$e.hydrateRoot=s.hydrateRoot,$e}var as=is();const os=ts(as);function J(){const s=h.useContext(es);if(s===void 0)throw new Error("useTheme must be used within a ThemeProvider");return s}const U=h.forwardRef(({variant:s="primary",size:a="md",underline:i="hover",external:n=!1,disabled:t=!1,className:c="",children:m,href:g,target:b,rel:v,...u},A)=>{const{theme:f}=J(),E={display:"inline-flex",alignItems:"center",gap:"var(--space-xs)",fontFamily:"var(--font-family)",fontWeight:"var(--font-weight-medium)",textDecoration:i==="always"?"underline":"none",transition:"var(--transition-base)",cursor:t?"not-allowed":"pointer",opacity:t?.6:1,pointerEvents:t?"none":"auto"},x={primary:{color:"var(--text-primary)"},secondary:{color:"var(--text-secondary)"},accent:{color:"var(--accent-500)"},muted:{color:"var(--text-muted)"}},y={sm:{fontSize:"var(--font-size-sm)"},md:{fontSize:"var(--font-size-base)"},lg:{fontSize:"var(--font-size-lg)"}},L={textDecoration:i==="hover"?"underline":void 0,color:s==="accent"?"var(--accent-600)":"var(--text-accent)"},N={...E,...x[s],...y[a]},k=n?"_blank":b,M=n?"noopener noreferrer":v;return e.jsxs("a",{ref:A,href:t?void 0:g,target:k,rel:M,style:N,className:c,onMouseEnter:B=>{!t&&i==="hover"&&Object.assign(B.currentTarget.style,L)},onMouseLeave:B=>{t||Object.assign(B.currentTarget.style,N)},...u,children:[m,n&&e.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",style:{marginLeft:"2px"},children:[e.jsx("path",{d:"M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"}),e.jsx("polyline",{points:"15,3 21,3 21,9"}),e.jsx("line",{x1:"10",y1:"14",x2:"21",y2:"3"})]})]})});U.displayName="Link";function ve(){const{theme:s}=J(),[a,i]=h.useState("lg");return h.useEffect(()=>{const n=()=>{const t=window.innerWidth;t<parseInt(s.breakpoints.sm)?i("xs"):t<parseInt(s.breakpoints.md)?i("sm"):t<parseInt(s.breakpoints.lg)?i("md"):t<parseInt(s.breakpoints.xl)?i("lg"):t<parseInt(s.breakpoints.xxl)?i("xl"):i("xxl")};return n(),window.addEventListener("resize",n),()=>window.removeEventListener("resize",n)},[s.breakpoints]),a}function ue(){const[s,a]=h.useState(!1);return h.useEffect(()=>{const i=()=>{const n="ontouchstart"in window||navigator.maxTouchPoints>0,t=window.innerWidth<768,c=/Android|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent);a(n||t||c)};return i(),window.addEventListener("resize",i),()=>window.removeEventListener("resize",i)},[]),s}function Sr(){const[s,a]=h.useState("landscape");return h.useEffect(()=>{const i=()=>{a(window.innerHeight>window.innerWidth?"portrait":"landscape")};return i(),window.addEventListener("resize",i),window.addEventListener("orientationchange",i),()=>{window.removeEventListener("resize",i),window.removeEventListener("orientationchange",i)}},[]),s}function ds(s){const a=ve();return s[a]??s.default}function kr(){const[s,a]=h.useState(!0);return h.useEffect(()=>{const i=()=>{const t=window.matchMedia("(hover: hover)").matches;a(t)};i();const n=window.matchMedia("(hover: hover)");return n.addEventListener("change",i),()=>n.removeEventListener("change",i)},[]),s}function Je(s,a={}){const{strategy:i="auto",preserve:n=[],force:t={},minTouchTarget:c="44px",autoSpacing:m=!0,autoTypography:g=!0}=a;ve();const b=ue(),v=Sr(),{theme:u}=J(),A=h.useMemo(()=>{if(!b&&i!=="optimize")return{containerStyle:s||{},itemStyle:{},isTransformed:!1,activeStrategy:"preserve"};const x=s||{};let y={...x},L={},N=i;if(i==="auto"){const k=x.display==="grid",M=x.display==="flex",B=k||M,I=x.gap&&(x.gap.toString().includes("lg")||x.gap.toString().includes("xl"));B||I?N="optimize":N="simplify"}switch(N){case"stack":y={...y,display:"flex",flexDirection:"column",gap:m?"var(--space-md)":y.gap,alignItems:"stretch"};break;case"simplify":x.display==="grid"&&(y.display="flex",y.flexDirection="column",y.gridTemplateColumns=void 0,y.gridTemplateRows=void 0),x.display==="flex"&&x.flexDirection==="row"&&(y.flexDirection="column");break;case"optimize":if(x.display==="grid"){const k=x.gridTemplateColumns;typeof k=="string"&&k.includes("repeat")&&(y.gridTemplateColumns="1fr")}if(x.display==="flex"&&(y.flexDirection=v==="landscape"&&!t.stack?"row":"column",y.flexWrap="wrap"),m){if(x.gap){const k=x.gap.toString();k.includes("xl")?y.gap="var(--space-lg)":k.includes("lg")?y.gap="var(--space-md)":k.includes("md")&&(y.gap="var(--space-sm)")}if(x.padding){const k=x.padding.toString();k.includes("xl")?y.padding="var(--space-lg)":k.includes("lg")&&(y.padding="var(--space-md)")}if(x.margin){const k=x.margin.toString();k.includes("xl")?y.margin="var(--space-lg)":k.includes("lg")&&(y.margin="var(--space-md)")}}t.increaseTouchTargets&&(L.minHeight=c,L.minWidth=c,L.display=L.display||"flex",L.alignItems="center",L.justifyContent="center");break}return t.singleColumn&&y.display==="grid"&&(y.gridTemplateColumns="1fr"),t.stack&&(y.display="flex",y.flexDirection="column"),t.reducePadding&&m&&(y.padding="var(--space-sm)"),n.forEach(k=>{x[k]!==void 0&&(y[k]=x[k])}),y.WebkitTapHighlightColor="transparent",y.touchAction="manipulation",g&&b&&(y.fontSize="0.9em",y.lineHeight="1.4"),{containerStyle:y,itemStyle:L,isTransformed:!0,activeStrategy:N}},[s,i,b,v,u,n,t,c,m,g]),f=x=>b?x.mobile:x.desktop,E=x=>b?Je(x,a).containerStyle:x;return{containerStyle:A.containerStyle,itemStyle:A.itemStyle,isTransformed:A.isTransformed,activeStrategy:A.activeStrategy,responsive:f,transform:E}}function ns(){const s=ue(),a=ve(),{theme:i}=J();return h.useMemo(()=>({css:n=>{if(!s)return n;const t={...n};return n.display==="grid"&&n.gridTemplateColumns?.toString().includes("repeat")&&(t.display="flex",t.flexDirection="column",delete t.gridTemplateColumns,delete t.gridTemplateRows),n.display==="flex"&&n.flexDirection==="row"&&(t.flexDirection="column"),n.gap?.toString().includes("xl")&&(t.gap="var(--space-lg)"),n.gap?.toString().includes("lg")&&(t.gap="var(--space-md)"),n.padding?.toString().includes("xl")&&(t.padding="var(--space-lg)"),n.padding?.toString().includes("lg")&&(t.padding="var(--space-md)"),t.WebkitTapHighlightColor="transparent",t.touchAction="manipulation",t},select:(n,t)=>s?t:n,classes:{container:`responsive-container ${s?"mobile":"desktop"} breakpoint-${a}`,item:`responsive-item ${s?"mobile-item":"desktop-item"}`,interactive:s?"touch-friendly":"hover-enabled"},device:{isMobile:s,breakpoint:a,isCompact:s}}),[s,a,i])}const j=h.forwardRef(({variant:s="primary",size:a="md",shape:i="rounded",fullWidth:n=!1,loading:t=!1,disabled:c=!1,leftIcon:m,rightIcon:g,className:b="",mobileOptimized:v=!0,children:u,...A},f)=>{const{theme:E}=J(),x=ue(),y=kr(),L=v&&x&&a==="sm"?"md":a,N={display:"inline-flex",alignItems:"center",justifyContent:"center",gap:i==="circle"?"0":"var(--space-xs)",fontFamily:"var(--font-family)",fontWeight:"var(--font-weight-medium)",border:"1px solid transparent",transition:y?"var(--transition-base)":"none",cursor:c||t?"not-allowed":"pointer",opacity:c?.6:1,width:n?"100%":"auto",position:"relative",overflow:"hidden",textAlign:"center",whiteSpace:i==="circle"?"nowrap":"normal",...v&&x&&{minHeight:"var(--touch-target-size)",WebkitTapHighlightColor:"var(--tap-highlight-color)",touchAction:"manipulation",userSelect:"none"}},k={primary:{backgroundColor:"var(--btn-primary-bg)",color:"var(--btn-primary-text)",borderColor:"var(--btn-primary-bg)"},secondary:{backgroundColor:"var(--btn-bg)",color:"var(--btn-text)",borderColor:"var(--btn-border)"},outline:{backgroundColor:"transparent",color:"var(--btn-text)",borderColor:"var(--btn-border)"},ghost:{backgroundColor:"transparent",color:"var(--btn-text)",borderColor:"transparent"},danger:{backgroundColor:"var(--error-color)",color:"white",borderColor:"var(--error-color)"}},M={sm:{padding:"var(--space-xs) var(--space-sm)",fontSize:"var(--font-size-sm)",minHeight:"calc(var(--font-size-sm) + var(--space-md))"},md:{padding:"var(--space-sm) var(--space-md)",fontSize:"var(--font-size-base)",minHeight:"calc(var(--font-size-base) + var(--space-lg))"},lg:{padding:"var(--space-md) var(--space-lg)",fontSize:"var(--font-size-lg)",minHeight:"calc(var(--font-size-lg) + var(--space-xl))"}},B={rounded:{borderRadius:"var(--radius-md)"},pill:{borderRadius:"9999px"},square:{borderRadius:"0"},circle:{borderRadius:"50%",aspectRatio:"1",padding:"0",minWidth:i==="circle"&&L==="sm"?"2rem":i==="circle"&&L==="md"?"2.5rem":i==="circle"&&L==="lg"?"3rem":"auto",width:i==="circle"&&L==="sm"?"2rem":i==="circle"&&L==="md"?"2.5rem":i==="circle"&&L==="lg"?"3rem":"auto",height:i==="circle"&&L==="sm"?"2rem":i==="circle"&&L==="md"?"2.5rem":i==="circle"&&L==="lg"?"3rem":"auto"}},I=$=>{switch($){case"primary":return{backgroundColor:"var(--btn-primary-bg-hover)"};case"secondary":return{backgroundColor:"var(--btn-bg-hover)"};case"outline":return{backgroundColor:"var(--btn-bg-hover)"};case"ghost":return{backgroundColor:"var(--bg-hover)"};case"danger":return{backgroundColor:"var(--error-color)",filter:"brightness(0.9)"};default:return{}}},D=$=>{switch($){case"primary":return{backgroundColor:"var(--btn-primary-bg-active)"};case"secondary":return{backgroundColor:"var(--btn-bg-active)"};case"outline":return{backgroundColor:"var(--btn-bg-active)"};case"ghost":return{backgroundColor:"var(--bg-active)"};case"danger":return{backgroundColor:"var(--error-color)",filter:"brightness(0.8)"};default:return{}}},z={...N,...k[s],...M[L],...B[i]},R=()=>e.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",style:{animation:"spin 1s linear infinite"},children:[e.jsx("circle",{cx:"12",cy:"12",r:"10"}),e.jsx("path",{d:"M12 2 A10 10 0 0 1 22 12"})]});return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
          @keyframes spin {
        ...
        `}),e.jsxs("button",{ref:f,disabled:c||t,style:z,className:`flowlab-button variant-${s} ${b}`.trim(),onMouseEnter:y?$=>{if(!c&&!t){const C=I(s);Object.assign($.currentTarget.style,C)}}:void 0,onMouseLeave:y?$=>{if(!c&&!t){const C=I(s);Object.keys(C).forEach(oe=>{const Z=oe;$.currentTarget.style[Z]=z[Z]||""})}}:void 0,onMouseDown:$=>{if(!c&&!t){const C=D(s);Object.assign($.currentTarget.style,C)}},onMouseUp:$=>{if(!c&&!t){const C=y?I(s):{};Object.assign($.currentTarget.style,C)}},...A,children:[t&&e.jsx(R,{}),m&&!t&&m,u,g&&!t&&g]})]})});j.displayName="Button";const q=h.forwardRef(({size:s="md",variant:a="default",type:i="default",isInvalid:n=!1,disabled:t=!1,leftIcon:c,rightIcon:m,label:g,helperText:b,errorMessage:v,className:u="",id:A,enableValidation:f=!0,showValidationIcon:E=!0,showPasswordToggle:x=!0,responsive:y=!0,onFocus:L,onBlur:N,onChange:k,value:M,...B},I)=>{const{theme:D}=J();ve();const z=ue(),[R,$]=h.useState(!1),[C,oe]=h.useState(!1),[Z,ee]=h.useState(!1),[se,re]=h.useState(""),[Te,ae]=h.useState(null),me=n||!!v||!!se,Fe=A||`input-${Math.random().toString(36).substr(2,9)}`,we=y&&z&&(s==="sm"||s==="lg")?"md":s;h.useEffect(()=>{if(f&&M){let W={isValid:!0,error:""};i==="email"?W=ce(M.toString()):i==="password"&&(W=he(M.toString())),ae(W.isValid),W.isValid||re(W.error)}},[]);const ce=W=>W?/^[^\s@]+@[^\s@]+\.(com|org|net|edu|gov|mil|int|co|io|me|info|biz|name|museum|coop|aero|[a-z]{2,3})$/i.test(W)?{isValid:!0,error:""}:{isValid:!1,error:"Please enter a valid email address"}:{isValid:!1,error:""},he=W=>{if(!W)return{isValid:!1,error:""};if(W.length<6)return{isValid:!1,error:"Password must be at least 6 characters"};if(W.length<8)return{isValid:!0,error:""};const G=/[A-Z]/.test(W),Q=/[a-z]/.test(W),ne=/\d/.test(W),ie=/[!@#$%^&*(),.?":{}|<>]/.test(W);return G&&Q&&ne&&ie?{isValid:!0,error:""}:{isValid:!0,error:""}},lr=()=>e.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[e.jsx("path",{d:"M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"}),e.jsx("circle",{cx:"12",cy:"12",r:"3"})]}),cr=()=>e.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[e.jsx("path",{d:"M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"}),e.jsx("line",{x1:"1",y1:"1",x2:"23",y2:"23"})]}),Le=()=>e.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:e.jsx("polyline",{points:"20,6 9,17 4,12"})}),Ze=()=>e.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[e.jsx("line",{x1:"18",y1:"6",x2:"6",y2:"18"}),e.jsx("line",{x1:"6",y1:"6",x2:"18",y2:"18"})]}),de=()=>e.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[e.jsx("path",{d:"M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"}),e.jsx("polyline",{points:"22,6 12,13 2,6"})]}),er=()=>e.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[e.jsx("rect",{x:"3",y:"11",width:"18",height:"11",rx:"2",ry:"2"}),e.jsx("circle",{cx:"12",cy:"16",r:"1"}),e.jsx("path",{d:"M7 11V7a5 5 0 0 1 10 0v4"})]}),pe=()=>{let W=S.inputBorder,G="none";return me?(W=S.errorColor,R&&(G=`0 0 0 2px ${S.errorLight}`)):R?(W=S.inputBorderFocus,G=`0 0 0 2px ${S.focusRing}`):C&&!t&&(W=S.inputBorderHover),{display:"flex",alignItems:"center",width:y&&z?"100%":"auto",borderRadius:a==="flushed"?"0":y&&z?"var(--border-radius-lg)":S.radiusMd,borderWidth:"1px",borderStyle:"solid",borderColor:W,backgroundColor:a==="filled"?S.bgElevated:S.inputBg,borderBottomWidth:a==="flushed"?"2px":"1px",borderTopWidth:a==="flushed"?"0":"1px",borderLeftWidth:a==="flushed"?"0":"1px",borderRightWidth:a==="flushed"?"0":"1px",paddingLeft:c?S.spaceXs:S.spaceSm,paddingRight:m?S.spaceXs:S.spaceSm,paddingTop:S.spaceXs,paddingBottom:S.spaceXs,boxShadow:G,transition:S.transitionBase,minHeight:y&&z?"var(--mobile-touch-target)":"auto",...te[we]}},rr={flex:1,border:"none",outline:"none",backgroundColor:"transparent",color:S.inputText,fontSize:S.fontSizeBase,fontFamily:"inherit",padding:"0",margin:c||m?`0 ${S.spaceXs}`:"0"},te={sm:{minHeight:`calc(${S.fontSizeSm} + ${S.spaceMd})`,fontSize:S.fontSizeSm},md:{minHeight:`calc(${S.fontSizeBase} + ${S.spaceLg})`,fontSize:S.fontSizeBase},lg:{minHeight:`calc(${S.fontSizeLg} + ${S.spaceXl})`,fontSize:S.fontSizeLg}},sr=()=>i==="password"?Z?"text":"password":i==="email"?"email":i==="default"?"text":i,Oe=()=>c||(i==="email"?e.jsx(de,{}):i==="password"?e.jsx(er,{}):null),Ie=()=>i==="email"?"Enter your email address":i==="password"?"Enter your password":"",Re=({password:W})=>{const Q=(ne=>{if(ne.length<6)return{level:0,text:"Too short",color:S.errorColor};let ie=0;return ne.length>=8&&ie++,/[A-Z]/.test(ne)&&ie++,/[a-z]/.test(ne)&&ie++,/\d/.test(ne)&&ie++,/[!@#$%^&*(),.?":{}|<>]/.test(ne)&&ie++,ie<2?{level:1,text:"Weak",color:S.errorColor}:ie<4?{level:2,text:"Fair",color:S.warningColor}:ie<5?{level:3,text:"Good",color:S.info}:{level:4,text:"Strong",color:S.successColor}})(W);return e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:S.spaceSm},children:[e.jsx("div",{style:{flex:1,height:"4px",backgroundColor:S.gray200,borderRadius:"2px",overflow:"hidden"},children:e.jsx("div",{style:{height:"100%",width:`${Q.level/4*100}%`,backgroundColor:Q.color,transition:S.transitionBase}})}),e.jsx("span",{style:{color:Q.color,minWidth:"60px",fontSize:S.fontSizeXs,fontWeight:S.fontWeightMedium},children:Q.text})]})},xe=()=>{const W=[];return f&&E&&M&&(Te===!0?W.push(e.jsxs("div",{style:{color:"#10b981"},children:[" ",e.jsx(Le,{})]},"validation")):Te===!1&&W.push(e.jsxs("div",{style:{color:"#ef4444"},children:[" ",e.jsx(Ze,{})]},"validation"))),i==="password"&&x&&W.push(e.jsx("button",{type:"button",onClick:()=>ee(!Z),style:{background:"none",border:"none",cursor:"pointer",padding:"0.25rem",display:"flex",alignItems:"center",color:S.textMuted,borderRadius:S.radiusSm},tabIndex:-1,children:Z?e.jsx(cr,{}):e.jsx(lr,{})},"password-toggle")),m&&W.push(e.jsx("div",{children:m},"custom")),W.length>0?e.jsx("div",{style:{display:"flex",alignItems:"center",gap:S.spaceXs},children:W}):null},ye=W=>{if($(!0),f&&i==="email"&&M){const G=ce(M.toString());ae(G.isValid),G.isValid||re(G.error)}L?.(W)},Pe=W=>{if($(!1),f&&M){let G={isValid:!0,error:""};i==="email"?G=ce(M.toString()):i==="password"&&(G=he(M.toString())),ae(G.isValid),re(G.error)}N?.(W)},pr=W=>{const G=W.target.value;if(f)if(G){let Q={isValid:!0,error:""};i==="email"?(Q=ce(G),ae(Q.isValid),Q.isValid?re(""):re(Q.error)):i==="password"?(Q=he(G),ae(Q.isValid),Q.isValid?re(""):re(Q.error)):(ae(!0),re(""))}else ae(null),re("");k?.(W)},tr=()=>{t||oe(!0)},X=()=>{oe(!1)};return e.jsxs("div",{className:u,children:[g&&e.jsx("label",{htmlFor:Fe,style:{display:"block",fontSize:S.fontSizeSm,fontWeight:S.fontWeightMedium,color:S.textPrimary,marginBottom:S.spaceXs},children:g}),e.jsxs("div",{style:pe(),onMouseEnter:tr,onMouseLeave:X,children:[Oe()&&e.jsx("div",{style:{display:"flex",alignItems:"center",color:S.textMuted,fontSize:te[we].fontSize},children:Oe()}),e.jsx("input",{ref:I,id:Fe,type:sr(),disabled:t,value:M,onFocus:ye,onBlur:Pe,onChange:pr,style:{...rr,...te[we],opacity:t?.6:1,cursor:t?"not-allowed":"text"},placeholder:B.placeholder||Ie(),...B}),xe()&&e.jsx("div",{style:{display:"flex",alignItems:"center",color:S.textMuted,fontSize:te[we].fontSize},children:xe()})]}),(b||v||se)&&e.jsx("div",{style:{marginTop:S.spaceXs,fontSize:S.fontSizeSm,color:me?S.errorColor:S.textSecondary},children:v||se||b}),i==="password"&&M&&f&&e.jsx("div",{style:{marginTop:S.spaceXs},children:e.jsx(Re,{password:M.toString()})})]})});q.displayName="Input";const o=h.forwardRef(({variant:s="elevated",padding:a="md",radius:i="md",shadow:n="md",hoverable:t=!1,className:c="",responsive:m=!0,children:g,...b},v)=>{const{theme:u}=J(),A=ve(),f=ue(),E=m&&f&&a==="lg"?"md":m&&f&&a==="md"?"sm":a,x=m&&f&&i==="lg"?"md":i,y={display:"flex",flexDirection:"column",position:"relative",transition:"var(--transition-base)",cursor:t?"pointer":"default",...m&&f&&{width:"100%",maxWidth:"100%",margin:"0"},...m&&(A==="xs"||A==="sm")&&{borderRadius:x==="lg"?"var(--radius-md)":x==="md"||x==="sm"?"var(--radius-sm)":"0"}},L={elevated:{backgroundColor:"var(--bg-surface)",border:"none"},outlined:{backgroundColor:"var(--bg-surface)",border:"1px solid var(--border-color)"},filled:{backgroundColor:"var(--bg-elevated)",border:"none"}},N={none:{padding:"0"},sm:{padding:"var(--space-sm)"},md:{padding:"var(--space-md)"},lg:{padding:"var(--space-lg)"}},k={none:{borderRadius:"0"},sm:{borderRadius:"var(--radius-sm)"},md:{borderRadius:"var(--radius-md)"},lg:{borderRadius:"var(--radius-lg)"}},M={none:{boxShadow:"none"},sm:{boxShadow:"var(--shadow-sm)"},md:{boxShadow:"var(--shadow-md)"},lg:{boxShadow:"var(--shadow-lg)"}},B=t?{transform:"translateY(-1px)",boxShadow:n!=="none"?"var(--shadow-lg)":"var(--shadow-md)"}:{},I={...y,...L[s],...N[E],...k[x],...M[n]};return e.jsx("div",{ref:v,style:I,className:c,onMouseEnter:D=>{t&&Object.assign(D.currentTarget.style,{...I,...B})},onMouseLeave:D=>{t&&Object.assign(D.currentTarget.style,I)},...b,children:g})});o.displayName="Card";const T=h.forwardRef(({className:s="",children:a,...i},n)=>e.jsx("div",{ref:n,style:{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:"var(--space-md)",paddingBottom:"var(--space-sm)",borderBottom:"1px solid var(--border-light)"},className:s,...i,children:a}));T.displayName="CardHeader";const d=h.forwardRef(({className:s="",children:a,...i},n)=>e.jsx("div",{ref:n,style:{flex:1},className:s,...i,children:a}));d.displayName="CardBody";const _e=h.forwardRef(({className:s="",children:a,...i},n)=>e.jsx("div",{ref:n,style:{display:"flex",alignItems:"center",justifyContent:"flex-end",gap:"var(--space-sm)",marginTop:"var(--space-md)",paddingTop:"var(--space-sm)",borderTop:"1px solid var(--border-light)"},className:s,...i,children:a}));_e.displayName="CardFooter";const p=({variant:s="default",size:a="md",shape:i="rounded",dot:n=!1,children:t,className:c=""})=>{const m={display:"inline-flex",alignItems:"center",justifyContent:"center",fontFamily:"var(--font-family)",fontWeight:"var(--font-weight-medium)",lineHeight:1,whiteSpace:"nowrap",verticalAlign:"middle",transition:"var(--transition-base)"},g={default:{backgroundColor:"var(--gray-100)",color:"var(--gray-800)"},primary:{backgroundColor:"var(--accent-500)",color:"white"},secondary:{backgroundColor:"var(--gray-500)",color:"white"},success:{backgroundColor:"var(--success-color)",color:"white"},warning:{backgroundColor:"var(--warning-color)",color:"white"},error:{backgroundColor:"var(--error-color)",color:"white"},info:{backgroundColor:"var(--info)",color:"white"}},b={sm:{fontSize:"var(--font-size-xs)",padding:n?"0":"var(--space-xs) var(--space-sm)",minWidth:n?"var(--space-sm)":"auto",height:n?"var(--space-sm)":"calc(var(--font-size-xs) + var(--space-xs) * 2)"},md:{fontSize:"var(--font-size-sm)",padding:n?"0":"var(--space-xs) var(--space-md)",minWidth:n?"var(--space-md)":"auto",height:n?"var(--space-md)":"calc(var(--font-size-sm) + var(--space-sm))"},lg:{fontSize:"var(--font-size-base)",padding:n?"0":"var(--space-sm) var(--space-lg)",minWidth:n?"var(--space-lg)":"auto",height:n?"var(--space-lg)":"calc(var(--font-size-base) + var(--space-md))"}},v={rounded:{borderRadius:"var(--radius-sm)"},pill:{borderRadius:"9999px"},square:{borderRadius:"0"}},u=n?{borderRadius:"50%",padding:"0"}:{},A={...m,...g[s],...b[a],...v[i],...u};return h.createElement("span",{style:A,className:c},n?null:t)},r=h.forwardRef(({as:s="p",size:a="md",weight:i="normal",color:n="primary",align:t="left",truncate:c=!1,lineClamp:m,className:g="",children:b,style:v,...u},A)=>{const{theme:f}=J(),E=s,x={margin:0,fontFamily:"var(--font-family)",lineHeight:1.5,textAlign:t},y={xs:{fontSize:"var(--font-size-xs)"},sm:{fontSize:"var(--font-size-sm)"},md:{fontSize:"var(--font-size-base)"},lg:{fontSize:"var(--font-size-lg)"},xl:{fontSize:"var(--font-size-xl)"},"2xl":{fontSize:"var(--font-size-2xl)"},"3xl":{fontSize:"var(--font-size-3xl)"}},L={normal:{fontWeight:"var(--font-weight-normal)"},medium:{fontWeight:"var(--font-weight-medium)"},semibold:{fontWeight:"var(--font-weight-semibold)"},bold:{fontWeight:"var(--font-weight-bold)"}},N={primary:{color:"var(--text-primary)"},secondary:{color:"var(--text-secondary)"},tertiary:{color:"var(--text-tertiary)"},muted:{color:"var(--text-muted)"},accent:{color:"var(--text-accent)"},success:{color:"var(--success-color)"},warning:{color:"var(--warning-color)"},error:{color:"var(--error-color)"},info:{color:"var(--info)"}},k=c?{overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}:{},M=m?{display:"-webkit-box",WebkitLineClamp:m,WebkitBoxOrient:"vertical",overflow:"hidden",textOverflow:"ellipsis"}:{},B={h1:{fontSize:"var(--font-size-3xl)",fontWeight:"var(--font-weight-bold)",lineHeight:1.2,marginBottom:"var(--space-lg)"},h2:{fontSize:"var(--font-size-2xl)",fontWeight:"var(--font-weight-bold)",lineHeight:1.3,marginBottom:"var(--space-md)"},h3:{fontSize:"var(--font-size-xl)",fontWeight:"var(--font-weight-semibold)",lineHeight:1.3,marginBottom:"var(--space-md)"},h4:{fontSize:"var(--font-size-lg)",fontWeight:"var(--font-weight-semibold)",lineHeight:1.4,marginBottom:"var(--space-sm)"},h5:{fontSize:"var(--font-size-base)",fontWeight:"var(--font-weight-semibold)",lineHeight:1.4,marginBottom:"var(--space-sm)"},h6:{fontSize:"var(--font-size-sm)",fontWeight:"var(--font-weight-semibold)",lineHeight:1.4,marginBottom:"var(--space-sm)"}},D=["h1","h2","h3","h4","h5","h6"].includes(s)?B[s]:{},z={...x,...D,...y[a],...L[i],...N[n],...k,...M,...v};return e.jsx(E,{ref:A,style:z,className:g,...u,children:b})});r.displayName="Text";const V=h.forwardRef(({size:s="md",variant:a="primary",thickness:i="medium",speed:n="normal",className:t="",...c},m)=>{const{theme:g}=J(),b={display:"inline-block",borderRadius:"50%",borderStyle:"solid",animation:`spin ${n==="slow"?"1.5s":n==="fast"?"0.6s":"0.8s"} linear infinite`,filter:"drop-shadow(0 0 2px rgba(0, 0, 0, 0.1))"},v={xs:{width:"12px",height:"12px"},sm:{width:"16px",height:"16px"},md:{width:"24px",height:"24px"},lg:{width:"32px",height:"32px"},xl:{width:"48px",height:"48px"}},u={thin:{borderWidth:"2px"},medium:{borderWidth:"3px"},thick:{borderWidth:"4px"}},A={primary:{borderColor:"rgba(128, 128, 128, 0.2)",borderTopColor:"var(--accent-500)",borderRightColor:"var(--accent-500)"},secondary:{borderColor:"rgba(128, 128, 128, 0.2)",borderTopColor:"var(--text-secondary)",borderRightColor:"var(--text-secondary)"},accent:{borderColor:"rgba(128, 128, 128, 0.2)",borderTopColor:"var(--accent-500)",borderRightColor:"var(--accent-600)"},success:{borderColor:"rgba(128, 128, 128, 0.2)",borderTopColor:"var(--success)",borderRightColor:"var(--success)"},warning:{borderColor:"rgba(128, 128, 128, 0.2)",borderTopColor:"var(--warning)",borderRightColor:"var(--warning)"},error:{borderColor:"rgba(128, 128, 128, 0.2)",borderTopColor:"var(--error)",borderRightColor:"var(--error)"}},f={...b,...v[s],...u[i],...A[a]};return be.useEffect(()=>{const E="spinner-keyframes";if(!document.getElementById(E)){const x=document.createElement("style");x.id=E,x.textContent=`
        @keyframes spin {
          0% { transform: rotate(0deg); }
          100% { transform: rotate(360deg); }
        }
      `,document.head.appendChild(x)}},[]),e.jsx("div",{ref:m,style:f,className:t,role:"status","aria-label":"Loading",...c})});V.displayName="Spinner";const P=h.forwardRef(({type:s="dots",size:a="md",variant:i="primary",speed:n="normal",text:t,textPosition:c="right",className:m="",...g},b)=>{const{theme:v}=J(),u=n==="slow"?"1.5s":n==="fast"?"0.8s":"1.2s",f={xs:{dotSize:"4px",gap:"2px",fontSize:"12px"},sm:{dotSize:"6px",gap:"3px",fontSize:"14px"},md:{dotSize:"8px",gap:"4px",fontSize:"16px"},lg:{dotSize:"10px",gap:"5px",fontSize:"18px"},xl:{dotSize:"12px",gap:"6px",fontSize:"20px"}}[a],x={primary:"var(--text-primary)",secondary:"var(--text-secondary)",accent:"var(--accent-500)",success:"var(--success)",warning:"var(--warning)",error:"var(--error)"}[i],y={display:"inline-flex",alignItems:"center",gap:"var(--space-sm)",fontFamily:"var(--font-family)",fontSize:f.fontSize,color:x},L={color:x,fontSize:f.fontSize,fontWeight:"var(--font-weight-medium)"},N=()=>{if(!t)return{flexDirection:"row"};switch(c){case"left":return{flexDirection:"row"};case"right":return{flexDirection:"row"};case"top":return{flexDirection:"column",alignItems:"center"};case"bottom":return{flexDirection:"column",alignItems:"center"};default:return{flexDirection:"row"}}};be.useEffect(()=>{const B="loading-indicator-keyframes";if(!document.getElementById(B)){const I=document.createElement("style");I.id=B,I.textContent=`
      ...
      `,document.head.appendChild(I)}},[]);const k=()=>{const B={width:f.dotSize,height:f.dotSize,backgroundColor:x,borderRadius:"50%",display:"inline-block",marginRight:f.gap},I={width:f.dotSize,height:`calc(${f.dotSize} * 2)`,backgroundColor:x,borderRadius:f.dotSize,display:"inline-block",marginRight:f.gap};switch(s){case"dots":return e.jsx("div",{style:{display:"flex",alignItems:"center",gap:f.gap},children:[0,1,2].map(D=>e.jsx("div",{style:{...B,animation:`bouncing-dots ${u} infinite`,animationDelay:`${D*.2}s`}},D))});case"pulse":return e.jsx("div",{style:{display:"flex",alignItems:"center",gap:f.gap},children:[0,1,2,3].map(D=>e.jsx("div",{style:{...B,animation:`pulse ${u} infinite`,animationDelay:`${D*.15}s`}},D))});case"wave":return e.jsx("div",{style:{display:"flex",alignItems:"center",gap:f.gap},children:[0,1,2,3,4].map(D=>e.jsx("div",{style:{...I,animation:`wave ${u} infinite`,animationDelay:`${D*.1}s`}},D))});case"bars":return e.jsx("div",{style:{display:"flex",alignItems:"end",gap:f.gap},children:[0,1,2,3].map(D=>e.jsx("div",{style:{width:f.dotSize,height:`calc(${f.dotSize} * ${1.5+Math.sin(D)*.5})`,backgroundColor:x,borderRadius:`${f.dotSize} ${f.dotSize} 0 0`,animation:`bars ${u} infinite`,animationDelay:`${D*.1}s`}},D))});case"bounce":return e.jsx("div",{style:{display:"flex",alignItems:"center",gap:f.gap},children:[0,1,2].map(D=>e.jsx("div",{style:{...B,animation:`bounce ${u} infinite`,animationDelay:`${D*.1}s`}},D))});default:return k()}},M=()=>{const B=k();if(!t)return B;const I=e.jsx("span",{style:L,children:t});switch(c){case"left":return e.jsxs(e.Fragment,{children:[I,B]});case"right":return e.jsxs(e.Fragment,{children:[B,I]});case"top":return e.jsxs(e.Fragment,{children:[I,B]});case"bottom":return e.jsxs(e.Fragment,{children:[B,I]});default:return e.jsxs(e.Fragment,{children:[B,I]})}};return e.jsx("div",{ref:b,style:{...y,...N()},className:m,role:"status","aria-label":t?`${t}...`:"Loading",...g,children:M()})});P.displayName="LoadingIndicator";const O=h.forwardRef(({variant:s="default",shape:a="square",size:i="md",fit:n="cover",loading:t="lazy",showSpinner:c=!0,fallback:m,className:g="",src:b,alt:v,onLoad:u,onError:A,...f},E)=>{const{theme:x}=J(),[y,L]=h.useState(!0),[N,k]=h.useState(!1),M={display:"block",objectFit:n,transition:"var(--transition-base)",backgroundColor:"var(--bg-surface)"},B={xs:{width:"32px",height:"32px"},sm:{width:"48px",height:"48px"},md:{width:"96px",height:"96px"},lg:{width:"128px",height:"128px"},xl:{width:"192px",height:"192px"},full:{width:"100%",height:"auto"}},I={square:{borderRadius:"0"},rounded:{borderRadius:"var(--radius-lg)"},circle:{borderRadius:"50%",aspectRatio:"1"},pill:{borderRadius:"var(--radius-full)",aspectRatio:"2/1"}},D={default:{border:"1px solid transparent"},bordered:{border:"3px solid var(--accent-500)",padding:"2px"},shadow:{boxShadow:"0 4px 12px rgba(0, 0, 0, 0.15)",border:"1px solid var(--border-color)"},elevated:{boxShadow:"0 8px 25px rgba(0, 0, 0, 0.25)",transform:"translateY(-4px)",border:"1px solid var(--border-color)"},"hover-lift":{cursor:"pointer",transition:"all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",border:"2px solid var(--border-color)",transform:"translateY(0px) scale(1)",boxShadow:"0 4px 12px rgba(0, 0, 0, 0.1)"}},z={...M,...B[i],...I[a],...D[s]},R={position:"relative",display:"inline-block",...B[i],...I[a]},$={position:"absolute",top:0,left:0,right:0,bottom:0,display:"flex",alignItems:"center",justifyContent:"center",backgroundColor:"var(--bg-surface)",borderRadius:I[a].borderRadius,opacity:y?1:0,pointerEvents:y?"auto":"none",transition:"var(--transition-base)"},C={...R,display:"flex",alignItems:"center",justifyContent:"center",backgroundColor:"var(--bg-surface)",border:"2px dashed var(--border-color)",color:"var(--text-secondary)",fontSize:"var(--font-size-sm)",textAlign:"center",padding:"var(--space-sm)"},oe=ee=>{L(!1),k(!1),u?.(ee)},Z=ee=>{L(!1),k(!0),A?.(ee)};return N&&m?e.jsx("div",{style:C,className:g,children:m}):N?e.jsxs("div",{style:C,className:g,children:[e.jsxs("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[e.jsx("rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",ry:"2"}),e.jsx("circle",{cx:"9",cy:"9",r:"2"}),e.jsx("path",{d:"m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21"})]}),e.jsx("div",{style:{marginTop:"4px",fontSize:"10px"},children:"Failed to load"})]}):e.jsxs("div",{style:R,className:g,children:[e.jsx("img",{ref:E,src:b,alt:v,loading:t,style:z,onLoad:oe,onError:Z,onMouseEnter:ee=>{s==="hover-lift"&&Object.assign(ee.currentTarget.style,{transform:"translateY(-8px) scale(1.05)",boxShadow:"0 12px 30px rgba(0, 0, 0, 0.3)",borderColor:"var(--accent-500)"})},onMouseLeave:ee=>{s==="hover-lift"&&Object.assign(ee.currentTarget.style,{transform:"translateY(0px) scale(1)",boxShadow:"0 4px 12px rgba(0, 0, 0, 0.1)",borderColor:"var(--border-color)"})},...f}),c&&e.jsx("div",{style:$,children:e.jsx(V,{size:"sm",variant:"secondary"})})]})});O.displayName="Image";const F=h.forwardRef(({leftIcon:s,rightIcon:a,disabled:i=!1,destructive:n=!1,className:t="",children:c,...m},g)=>{const{theme:b}=J(),v={display:"flex",alignItems:"center",gap:"var(--space-xs)",width:"100%",padding:"var(--space-xs) var(--space-sm)",border:"none",backgroundColor:"transparent",color:n?"var(--error-color)":"var(--text-primary)",fontSize:"var(--font-size-sm)",fontFamily:"var(--font-family)",textAlign:"left",cursor:i?"not-allowed":"pointer",opacity:i?.6:1,transition:"var(--transition-fast)",outline:"none"},u={backgroundColor:n?"var(--error-light)":"var(--bg-hover)"},A={backgroundColor:n?"var(--error-light)":"var(--bg-hover)",boxShadow:`inset 0 0 0 1px ${n?"var(--error-color)":"var(--focus-ring)"}`};return e.jsxs("button",{ref:g,disabled:i,style:v,className:t,onMouseEnter:f=>{i||Object.assign(f.currentTarget.style,{...v,...u})},onMouseLeave:f=>{i||Object.assign(f.currentTarget.style,v)},onFocus:f=>{i||Object.assign(f.currentTarget.style,{...v,...A})},onBlur:f=>{i||Object.assign(f.currentTarget.style,v)},...m,children:[s&&e.jsx("span",{style:{display:"flex",alignItems:"center",fontSize:"16px"},children:s}),e.jsx("span",{style:{flex:1},children:c}),a&&e.jsx("span",{style:{display:"flex",alignItems:"center",fontSize:"12px",opacity:.7},children:a})]})});F.displayName="DropdownItem";const Se=({className:s=""})=>e.jsx("div",{className:s,style:{height:"1px",backgroundColor:"var(--border-light)",margin:"var(--space-xs) 0"}}),fe=h.forwardRef(({className:s="",children:a,...i},n)=>e.jsx("div",{ref:n,className:s,style:{padding:"var(--space-xs) var(--space-sm)",fontSize:"var(--font-size-xs)",fontWeight:"var(--font-weight-semibold)",color:"var(--text-muted)",textTransform:"uppercase",letterSpacing:"0.05em"},...i,children:a}));fe.displayName="DropdownLabel";const Tr=h.forwardRef(({className:s="",align:a="start",side:i="bottom",sideOffset:n=4,alignOffset:t=0,children:c,style:m,...g},b)=>{const{theme:v}=J(),u={minWidth:"220px",backgroundColor:"var(--bg-surface)",border:"1px solid var(--border-color)",borderRadius:"var(--radius-md)",boxShadow:"var(--shadow-lg)",padding:"var(--space-xs)",zIndex:"var(--z-dropdown)",outline:"none",...m};return e.jsx("div",{ref:b,className:s,style:u,...g,children:c})});Tr.displayName="DropdownContent";const Y=h.forwardRef(({children:s,trigger:a,open:i,onOpenChange:n,disabled:t=!1,align:c="start",side:m="bottom",sideOffset:g=4,responsive:b=!0,className:v=""},u)=>{const[A,f]=h.useState(!1),E=i!==void 0,x=E?i:A;ve();const y=ue(),L=h.useRef(null),N=h.useRef(null),k=h.useRef(null),M=z=>{t||(E?n?.(z):f(z))};h.useEffect(()=>{if(!x)return;const z=R=>{L.current&&!L.current.contains(R.target)&&M(!1)};return document.addEventListener("mousedown",z),()=>document.removeEventListener("mousedown",z)},[x]),h.useEffect(()=>{if(!x)return;const z=R=>{R.key==="Escape"&&M(!1)};return document.addEventListener("keydown",z),()=>document.removeEventListener("keydown",z)},[x]);const B=()=>{const z={position:"absolute",zIndex:"var(--z-dropdown)",minWidth:b&&y?"100vw":"max-content",maxWidth:b&&y?"100vw":"400px"};if(b&&y)return z.top="calc(100% + 8px)",z.left="0",z.right="0",z.transform="none",z;switch(m){case"top":z.bottom=`calc(100% + ${g}px)`;break;case"bottom":z.top=`calc(100% + ${g}px)`;break;case"left":z.right=`calc(100% + ${g}px)`;break;case"right":z.left=`calc(100% + ${g}px)`;break}if(m==="top"||m==="bottom")switch(c){case"start":z.left="0";break;case"center":z.left="50%",z.transform="translateX(-50%)";break;case"end":z.right="0";break}else switch(c){case"start":z.top="0";break;case"center":z.top="50%",z.transform="translateY(-50%)";break;case"end":z.bottom="0";break}return z},I=z=>{z.preventDefault(),M(!x)},D=be.cloneElement(a,{ref:N,onClick:I,"aria-expanded":x,"aria-haspopup":"menu",disabled:t});return e.jsx("div",{ref:u,className:v,style:{position:"relative",display:"inline-block"},children:e.jsxs("div",{ref:L,children:[D,x&&e.jsx("div",{style:B(),children:e.jsx(Tr,{ref:k,align:c,side:m,sideOffset:g,role:"menu",onKeyDown:z=>{if(z.key==="ArrowDown"||z.key==="ArrowUp"){z.preventDefault();const R=k.current?.querySelectorAll('[role="menuitem"]:not([disabled])');if(!R||R.length===0)return;const $=Array.from(R).indexOf(document.activeElement);let C;z.key==="ArrowDown"?C=$<R.length-1?$+1:0:C=$>0?$-1:R.length-1,R[C].focus()}},children:be.Children.map(s,z=>be.isValidElement(z)&&z.type===F?be.cloneElement(z,{role:"menuitem",onClick:R=>{z.props.onClick?.(R),R.defaultPrevented||M(!1)}}):z)})})]})})});Y.displayName="Dropdown";const ls=s=>s?s.includes("youtube.com/watch")||s.includes("youtu.be/")||s.includes("youtube.com/embed/")?"youtube":s.includes("vimeo.com/")?"vimeo":(/\.(mp4|webm|ogg|mov|avi|mkv)(\?.*)?$/i.test(s),"html5"):"html5",cs=(s,a)=>{switch(a){case"youtube":const i=s.match(/(?:youtube\.com\/watch\?v=|youtu\.be\/|youtube\.com\/embed\/)([^&\n?#]+)/);return i?i[1]:"";case"vimeo":const n=s.match(/vimeo\.com\/(\d+)/);return n?n[1]:"";default:return""}},ps=`
  @keyframes spin {
    0% { transform: rotate(0deg); }
    100% { transform: rotate(360deg); }
  }
`;if(typeof document<"u"&&!document.querySelector("#video-quality-spinner-styles")){const s=document.createElement("style");s.id="video-quality-spinner-styles",s.textContent=ps,document.head.appendChild(s)}const H=h.forwardRef(({as:s,variant:a="default",shape:i="rounded",size:n="md",fit:t="cover",showSpinner:c=!0,showControls:m=!0,showMenu:g=!0,enableDownload:b=!1,enableFullscreen:v=!0,autoplayOnLoad:u=!1,muteAudioOnPlay:A=!1,enableLoop:f=!1,showPlaybackSpeed:E=!1,showVideoQuality:x=!1,videoQualities:y=[{label:"Auto",value:"auto"},{label:"1080p",value:"1080p"},{label:"720p",value:"720p"},{label:"480p",value:"480p"},{label:"360p",value:"360p"}],fallback:L,className:N="",src:k,onLoadStart:M,onLoadedData:B,onError:I,...D},z)=>{const{theme:R}=J(),$=h.useRef(null),[C,oe]=h.useState(!0),[Z,ee]=h.useState(!1),[se,re]=h.useState(!1),[Te,ae]=h.useState(0),[me,Fe]=h.useState(0),[Ue,we]=h.useState(1),[ce,he]=h.useState(A),[lr,cr]=h.useState(!1),[Le,Ze]=h.useState(!1),[de,er]=h.useState(1),[pe,rr]=h.useState(f),[te,sr]=h.useState(y[0]?.value||"auto"),[Oe,Ie]=h.useState(!1),[Re,xe]=h.useState(""),ye=ls(k||""),Pe=cs(k||"",ye),tr=(s||(ye==="html5"?"player":"url"))==="url"&&ye!=="html5",X=z||$,W=({size:l=24,color:w="currentColor"})=>e.jsx("svg",{width:l,height:l,viewBox:"0 0 24 24",fill:w,children:e.jsx("path",{d:"M8 5v14l11-7z"})}),G=({size:l=24,color:w="currentColor"})=>e.jsx("svg",{width:l,height:l,viewBox:"0 0 24 24",fill:w,children:e.jsx("path",{d:"M6 19h4V5H6v14zm8-14v14h4V5h-4z"})}),Q=({size:l=16,color:w="currentColor",level:K="high"})=>K==="muted"?e.jsx("svg",{width:l,height:l,viewBox:"0 0 24 24",fill:w,children:e.jsx("path",{d:"M16.5 12c0-1.77-1.02-3.29-2.5-4.03v2.21l2.45 2.45c.03-.2.05-.41.05-.63zm2.5 0c0 .94-.2 1.82-.54 2.64l1.51 1.51C20.63 14.91 21 13.5 21 12c0-4.28-2.99-7.86-7-8.77v2.06c2.89.86 5 3.54 5 6.71zM4.27 3L3 4.27 7.73 9H3v6h4l5 5v-6.73l4.25 4.25c-.67.52-1.42.93-2.25 1.18v2.06c1.38-.31 2.63-.95 3.69-1.81L19.73 21 21 19.73l-9-9L4.27 3zM12 4L9.91 6.09 12 8.18V4z"})}):K==="low"?e.jsx("svg",{width:l,height:l,viewBox:"0 0 24 24",fill:w,children:e.jsx("path",{d:"M3 9v6h4l5 5V4L7 9H3zm13.5 3c0-1.77-1.02-3.29-2.5-4.03v8.05c1.48-.73 2.5-2.25 2.5-4.02z"})}):e.jsx("svg",{width:l,height:l,viewBox:"0 0 24 24",fill:w,children:e.jsx("path",{d:"M3 9v6h4l5 5V4L7 9H3zm13.5 3c0-1.77-1.02-3.29-2.5-4.03v8.05c1.48-.73 2.5-2.25 2.5-4.02zM14 3.23v2.06c2.89.86 5 3.54 5 6.71s-2.11 5.85-5 6.71v2.06c4.01-.91 7-4.49 7-8.77s-2.99-7.86-7-8.77z"})}),ne=({size:l=16,color:w="currentColor"})=>e.jsx("svg",{width:l,height:l,viewBox:"0 0 24 24",fill:w,children:e.jsx("path",{d:"M12 8c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0 2c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0 6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z"})}),ie=({size:l=16,color:w="currentColor"})=>e.jsx("svg",{width:l,height:l,viewBox:"0 0 24 24",fill:w,children:e.jsx("path",{d:"M19 9h-4V3H9v6H5l7 7 7-7zM5 18v2h14v-2H5z"})}),Ir=({size:l=16,color:w="currentColor"})=>e.jsx("svg",{width:l,height:l,viewBox:"0 0 24 24",fill:w,children:e.jsx("path",{d:"M4 12c0 4.42 3.58 8 8 8s8-3.58 8-8h-2c0 3.31-2.69 6-6 6s-6-2.69-6-6 2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L14 9h7V2l-2.35 2.35C17.15 2.85 14.74 2 12 2 6.48 2 2 6.48 2 12z"})}),Rr=({size:l=32,color:w="currentColor"})=>e.jsxs("svg",{width:l,height:l,viewBox:"0 0 24 24",fill:"none",stroke:w,strokeWidth:"2",children:[e.jsx("polygon",{points:"23 7 16 12 23 17 23 7"}),e.jsx("rect",{width:"15",height:"14",x:"1",y:"5",rx:"2",ry:"2"}),e.jsx("line",{x1:"8",x2:"8",y1:"21",y2:"3"})]}),Pr=({size:l=16,color:w="currentColor"})=>e.jsx("svg",{width:l,height:l,viewBox:"0 0 24 24",fill:w,children:e.jsx("path",{d:"M7 14H5v5h5v-2H7v-3zm-2-4h2V7h3V5H5v5zm12 7h-3v2h5v-5h-2v3zM14 5v2h3v3h2V5h-5z"})}),Ar=({size:l=16,color:w="currentColor"})=>e.jsx("svg",{width:l,height:l,viewBox:"0 0 24 24",fill:w,children:e.jsx("path",{d:"M5 16h3v3h2v-5H5v2zm3-8H5v2h5V5H8v3zm6 11h2v-3h3v-2h-5v5zm2-11V5h-2v5h5V8h-3z"})}),Dr=({size:l=16,color:w="currentColor"})=>e.jsx("svg",{width:l,height:l,viewBox:"0 0 24 24",fill:w,children:e.jsx("path",{d:"M12 4V1L8 5l4 4V6c3.31 0 6 2.69 6 6 0 1.01-.25 1.97-.7 2.8l1.46 1.46C19.54 15.03 20 13.57 20 12c0-4.42-3.58-8-8-8zm0 14c-3.31 0-6-2.69-6-6 0-1.01.25-1.97.7-2.8L5.24 7.74C4.46 8.97 4 10.43 4 12c0 4.42 3.58 8 8 8v3l4-4-4-4v3z"})}),mr=({size:l=16,color:w="currentColor"})=>e.jsxs("svg",{width:l,height:l,viewBox:"0 0 24 24",fill:w,children:[e.jsx("path",{d:"M20.38 8.57l-1.23 1.85a8 8 0 0 1-.22 7.58H5.07A8 8 0 0 1 15.58 6.85l1.85-1.23A10 10 0 0 0 3.35 19a2 2 0 0 0 1.72 1h13.85a2 2 0 0 0 1.74-1 10 10 0 0 0-.27-10.44z"}),e.jsx("path",{d:"M10.59 15.41a2 2 0 0 0 2.83 0l5.66-8.49-8.49 5.66a2 2 0 0 0 0 2.83z"})]}),hr=({size:l=16,color:w="currentColor"})=>e.jsx("svg",{width:l,height:l,viewBox:"0 0 24 24",fill:w,children:e.jsx("path",{d:"M17 10.5V7c0-.55-.45-1-1-1H4c-.55 0-1 .45-1 1v10c0 .55.45 1 1 1h12c.55 0 1-.45 1-1v-3.5l4 4v-11l-4 4zM14 13h-3v3H9v-3H6v-2h3V8h2v3h3v2z"})}),Mr=l=>{oe(!0),ee(!1),M?.(l)},Wr=l=>{const w=l.currentTarget;oe(!1),ee(!1),Fe(w.duration),B?.(l)},Er=l=>{oe(!1),ee(!0),I?.(l)},Hr=l=>{ae(l.currentTarget.currentTime)},Vr=()=>re(!0),Nr=()=>re(!1),xr=()=>{const l=X.current;l&&(se?l.pause():l.play())},Ur=l=>{const w=X.current;if(!w||!me)return;const K=l.currentTarget.getBoundingClientRect(),je=(l.clientX-K.left)/K.width*me;w.currentTime=je,ae(je)},Or=l=>{const w=X.current,K=parseFloat(l.target.value);w&&(w.volume=K,we(K),he(K===0))},$r=()=>{const l=X.current;l&&(ce?(l.volume=Ue,l.muted=!1,he(!1)):(l.muted=!0,he(!0)))},qr=()=>{if(k&&b){const l=document.createElement("a");l.href=k,l.download="video.mp4",document.body.appendChild(l),l.click(),document.body.removeChild(l)}},Xr=()=>{if(v)try{Le?document.exitFullscreen?document.exitFullscreen():document.webkitExitFullscreen&&document.webkitExitFullscreen():X.current?.requestFullscreen?X.current.requestFullscreen():X.current?.webkitRequestFullscreen&&X.current.webkitRequestFullscreen()}catch(l){console.warn("Fullscreen not supported:",l)}},Gr=l=>{const w=X.current;w&&(w.playbackRate=l,er(l))},Kr=()=>{const l=X.current;if(!l)return;const w=!pe;l.loop=w,rr(w)},Qr=()=>{const l=X.current;l&&(l.currentTime=0,ae(0),se||l.play())},Yr=l=>{const w=y.find(je=>je.value===l);if(!w)return;const K=X.current;if(!K)return;const fr=K.currentTime,wr=!K.paused;if(Ie(!0),xe(`Switching to ${w.label}...`),w.src&&w.src!==K.src){K.src=w.src,K.load();const je=()=>{K.currentTime=fr,wr&&K.play().catch(()=>{}),Ie(!1),xe(`Quality changed to ${w.label}`),setTimeout(()=>xe(""),2e3),K.removeEventListener("loadeddata",je)};K.addEventListener("loadeddata",je)}else setTimeout(()=>{Ie(!1),xe(`Quality set to ${w.label}`),setTimeout(()=>xe(""),2e3)},500);sr(l)},gr=l=>{const w=Math.floor(l/60),K=Math.floor(l%60);return`${w}:${K.toString().padStart(2,"0")}`},vr={xs:{width:"160px",height:"90px"},sm:{width:"240px",height:"135px"},md:{width:"320px",height:"180px"},lg:{width:"480px",height:"270px"},xl:{width:"640px",height:"360px"},full:{width:"100%",height:"auto"}},ir={square:{borderRadius:"0"},rounded:{borderRadius:"var(--radius-lg)"},pill:{borderRadius:"var(--radius-full)"}},ur={default:{border:"1px solid var(--border-color)"},bordered:{border:"3px solid var(--accent-500)",padding:"2px"},shadow:{boxShadow:"0 4px 12px rgba(0, 0, 0, 0.15)",border:"1px solid var(--border-color)"},elevated:{boxShadow:"0 8px 25px rgba(0, 0, 0, 0.25)",transform:"translateY(-4px)",border:"1px solid var(--border-color)"},"hover-lift":{cursor:"pointer",transition:"all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",border:"2px solid var(--border-color)",transform:"translateY(0px) scale(1)",boxShadow:"0 4px 12px rgba(0, 0, 0, 0.1)"}},yr={...{display:"block",objectFit:t,transition:"var(--transition-base)",backgroundColor:"var(--bg-surface)",outline:"none",width:"100%",height:"100%",...ir[i],...ur[a]}},jr={position:"relative",display:"inline-block",overflow:"visible",background:"transparent",border:"none",...vr[n]},_r={position:"absolute",top:0,left:0,right:0,bottom:0,display:"flex",alignItems:"center",justifyContent:"center",backgroundColor:"rgba(0, 0, 0, 0.7)",borderRadius:ir[i].borderRadius,opacity:C?1:0,pointerEvents:C?"auto":"none",transition:"var(--transition-base)",zIndex:15},br={...vr[n],...ur[a],...ir[i],display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",backgroundColor:"var(--bg-surface)",border:"2px dashed var(--border-color)",color:"var(--text-secondary)",fontSize:"var(--font-size-sm)",textAlign:"center",padding:"var(--space-sm)"},Jr={position:"absolute",bottom:0,left:0,right:0,background:"linear-gradient(transparent, rgba(0, 0, 0, 0.8))",padding:"var(--space-sm)",opacity:1,transition:"opacity 0.3s ease",pointerEvents:"auto",borderRadius:"0",zIndex:10},Zr={position:"absolute",top:"50%",left:"50%",transform:"translate(-50%, -50%)",background:"rgba(0, 0, 0, 0.7)",border:"none",borderRadius:"50%",width:"60px",height:"60px",color:"white",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"24px",opacity:!se&&!C?1:0,transition:"all 0.3s ease",pointerEvents:!se&&!C?"auto":"none",zIndex:5};if(h.useEffect(()=>{const l=X.current;if(!l)return;const w=()=>{Fe(l.duration)};return l.addEventListener("loadedmetadata",w),()=>l.removeEventListener("loadedmetadata",w)},[]),h.useEffect(()=>{const l=()=>{Ze(!!document.fullscreenElement||!!document.webkitFullscreenElement)};return document.addEventListener("fullscreenchange",l),document.addEventListener("webkitfullscreenchange",l),()=>{document.removeEventListener("fullscreenchange",l),document.removeEventListener("webkitfullscreenchange",l)}},[]),h.useEffect(()=>{if(u&&X.current&&!Z){const l=async()=>{try{const w=X.current;A&&(w.muted=!0,he(!0)),await w.play(),re(!0)}catch(w){console.warn("Autoplay failed:",w)}};if(X.current.readyState>=3)l();else{const w=()=>{l(),X.current?.removeEventListener("canplay",w)};X.current.addEventListener("canplay",w)}}},[u,A,Z]),h.useEffect(()=>{X.current&&(X.current.loop=pe)},[pe]),h.useEffect(()=>{X.current&&(X.current.playbackRate=de)},[de]),Z&&L)return e.jsx("div",{style:br,className:N,children:L});if(Z)return e.jsxs("div",{style:br,className:N,children:[e.jsx(Rr,{size:32,color:"var(--text-secondary)"}),e.jsx("div",{style:{fontSize:"12px",marginTop:"8px"},children:"Failed to load video"})]});if(tr&&Pe){const l=()=>{switch(ye){case"youtube":return`https://www.youtube.com/embed/${Pe}?enablejsapi=1&origin=${window.location.origin}`;case"vimeo":return`https://player.vimeo.com/video/${Pe}`;default:return""}};return e.jsxs("div",{style:jr,className:N,children:[e.jsx("iframe",{src:l(),style:{...yr,border:"none"},allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture",allowFullScreen:!0,title:"Video Player"}),e.jsx("div",{style:{position:"absolute",top:"var(--space-sm)",left:"var(--space-sm)",backgroundColor:"rgba(0, 0, 0, 0.8)",color:"white",padding:"var(--space-xs) var(--space-sm)",borderRadius:"var(--radius-sm)",fontSize:"var(--font-size-xs)",fontWeight:"500",textTransform:"uppercase",zIndex:10},children:ye})]})}return e.jsxs("div",{style:jr,className:N,children:[e.jsx("video",{ref:X,src:k,style:yr,onLoadStart:Mr,onLoadedData:Wr,onError:Er,onTimeUpdate:Hr,onPlay:Vr,onPause:Nr,onMouseEnter:l=>{a==="hover-lift"&&Object.assign(l.currentTarget.parentElement.style,{transform:"translateY(-8px) scale(1.02)",boxShadow:"0 12px 30px rgba(0, 0, 0, 0.3)",borderColor:"var(--accent-500)"})},onMouseLeave:l=>{a==="hover-lift"&&Object.assign(l.currentTarget.parentElement.style,{transform:"translateY(0px) scale(1)",boxShadow:"0 4px 12px rgba(0, 0, 0, 0.1)",borderColor:"var(--border-color)"})},...D}),e.jsx("button",{style:Zr,onClick:xr,"aria-label":se?"Pause":"Play",children:se?e.jsx(G,{size:24,color:"white"}):e.jsx(W,{size:24,color:"white"})}),m&&e.jsx("div",{style:Jr,children:e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"var(--space-sm)",marginBottom:"var(--space-xs)"},children:[e.jsx("button",{onClick:xr,style:{background:"none",border:"none",color:"white",cursor:"pointer",fontSize:"18px",padding:"4px",borderRadius:"4px",display:"flex",alignItems:"center",justifyContent:"center"},"aria-label":se?"Pause":"Play",children:se?e.jsx(G,{size:18,color:"white"}):e.jsx(W,{size:18,color:"white"})}),e.jsx("div",{style:{flex:1,height:"4px",backgroundColor:"rgba(255, 255, 255, 0.3)",borderRadius:"2px",cursor:"pointer",position:"relative"},onClick:Ur,children:e.jsx("div",{style:{height:"100%",backgroundColor:"var(--accent-500)",borderRadius:"2px",width:`${me?Te/me*100:0}%`,transition:"width 0.1s ease"}})}),e.jsxs("div",{style:{color:"white",fontSize:"12px",fontFamily:"monospace",minWidth:"80px",textAlign:"center"},children:[gr(Te)," / ",gr(me)]}),e.jsx("button",{onClick:$r,style:{background:"none",border:"none",color:"white",cursor:"pointer",fontSize:"16px",padding:"4px",display:"flex",alignItems:"center",justifyContent:"center"},"aria-label":ce?"Unmute":"Mute",children:e.jsx(Q,{size:16,color:"white",level:ce?"muted":Ue>.5?"high":"low"})}),e.jsx("input",{type:"range",min:"0",max:"1",step:"0.1",value:ce?0:Ue,onChange:Or,style:{width:"60px",height:"4px",background:"rgba(255, 255, 255, 0.3)",outline:"none",borderRadius:"2px"}}),g&&e.jsxs(Y,{trigger:e.jsx("button",{style:{background:"none",border:"none",color:"white",cursor:"pointer",fontSize:"16px",padding:"4px",borderRadius:"4px",display:"flex",alignItems:"center",justifyContent:"center"},"aria-label":"More options",children:e.jsx(ne,{size:16,color:"white"})}),align:"end",side:"top",sideOffset:8,children:[v&&e.jsx(F,{leftIcon:Le?e.jsx(Ar,{size:16}):e.jsx(Pr,{size:16}),onClick:Xr,style:{color:"var(--text-primary)",fontWeight:"normal",display:"flex",alignItems:"center",gap:"var(--space-xs)",width:"100%",padding:"var(--space-xs) var(--space-sm)",border:"none",backgroundColor:"transparent",fontSize:"var(--font-size-sm)",fontFamily:"var(--font-family)",textAlign:"left",cursor:"pointer",opacity:1,transition:"var(--transition-fast)",outline:"none"},children:Le?"Exit Fullscreen":"Fullscreen"}),f&&e.jsxs(F,{leftIcon:e.jsx(Dr,{size:16,color:pe?"var(--primary)":"currentColor"}),onClick:Kr,style:{color:pe?"var(--primary)":"var(--text-primary)",fontWeight:pe?"500":"normal",display:"flex",alignItems:"center",gap:"var(--space-xs)",width:"100%",padding:"var(--space-xs) var(--space-sm)",border:"none",backgroundColor:"transparent",fontSize:"var(--font-size-sm)",fontFamily:"var(--font-family)",textAlign:"left",cursor:"pointer",opacity:1,transition:"var(--transition-fast)",outline:"none"},children:["Loop ",pe?"(On)":"(Off)"]}),E&&e.jsxs(Y,{trigger:e.jsxs(F,{leftIcon:e.jsx(mr,{size:16}),rightIcon:"›",style:{color:"var(--text-primary)",fontWeight:"normal",display:"flex",alignItems:"center",gap:"var(--space-xs)",width:"100%",padding:"var(--space-xs) var(--space-sm)",border:"none",backgroundColor:"transparent",fontSize:"var(--font-size-sm)",fontFamily:"var(--font-family)",textAlign:"left",cursor:"pointer",opacity:1,transition:"var(--transition-fast)",outline:"none"},children:["Playback Speed (",de===1?"Normal":`${de}x`,")"]}),align:"start",side:"right",sideOffset:4,children:[e.jsx(fe,{children:"Playback Speed"}),[.5,.75,1,1.25,1.5,2].map(l=>e.jsx(F,{leftIcon:e.jsx(mr,{size:16,color:de===l?"var(--primary)":"currentColor"}),rightIcon:de===l?"[✓]":void 0,onClick:()=>Gr(l),style:{color:de===l?"var(--primary)":"var(--text-primary)",fontWeight:de===l?"500":"normal",display:"flex",alignItems:"center",gap:"var(--space-xs)",width:"100%",padding:"var(--space-xs) var(--space-sm)",border:"none",backgroundColor:"transparent",fontSize:"var(--font-size-sm)",fontFamily:"var(--font-family)",textAlign:"left",cursor:"pointer",opacity:1,transition:"var(--transition-fast)",outline:"none"},children:l===1?"Normal":`${l}x`},l))]}),x&&y.length>0&&e.jsxs(Y,{trigger:e.jsxs(F,{leftIcon:e.jsx(hr,{size:16}),rightIcon:"›",style:{color:"var(--text-primary)",fontWeight:"normal",display:"flex",alignItems:"center",gap:"var(--space-xs)",width:"100%",padding:"var(--space-xs) var(--space-sm)",border:"none",backgroundColor:"transparent",fontSize:"var(--font-size-sm)",fontFamily:"var(--font-family)",textAlign:"left",cursor:"pointer",opacity:1,transition:"var(--transition-fast)",outline:"none"},children:["Quality (",y.find(l=>l.value===te)?.label||"Auto",")"]}),align:"start",side:"right",sideOffset:4,children:[e.jsx(fe,{children:"Video Quality"}),y.map(l=>e.jsx(F,{leftIcon:e.jsx(hr,{size:16,color:te===l.value?"var(--primary)":"currentColor"}),rightIcon:te===l.value?"[✓]":void 0,onClick:()=>Yr(l.value),style:{color:te===l.value?"var(--primary)":"var(--text-primary)",fontWeight:te===l.value?"500":"normal",display:"flex",alignItems:"center",gap:"var(--space-xs)",width:"100%",padding:"var(--space-xs) var(--space-sm)",border:"none",backgroundColor:"transparent",fontSize:"var(--font-size-sm)",fontFamily:"var(--font-family)",textAlign:"left",cursor:"pointer",opacity:1,transition:"var(--transition-fast)",outline:"none"},children:l.label},l.value))]}),(b||v||f||E||x)&&e.jsx(Se,{}),e.jsx(F,{leftIcon:e.jsx(Ir,{size:16}),onClick:Qr,style:{color:"var(--text-primary)",fontWeight:"normal",display:"flex",alignItems:"center",gap:"var(--space-xs)",width:"100%",padding:"var(--space-xs) var(--space-sm)",border:"none",backgroundColor:"transparent",fontSize:"var(--font-size-sm)",fontFamily:"var(--font-family)",textAlign:"left",cursor:"pointer",opacity:1,transition:"var(--transition-fast)",outline:"none"},children:"Restart"}),b&&e.jsx(F,{leftIcon:e.jsx(ie,{size:16}),onClick:qr,style:{color:"var(--text-primary)",fontWeight:"normal",display:"flex",alignItems:"center",gap:"var(--space-xs)",width:"100%",padding:"var(--space-xs) var(--space-sm)",border:"none",backgroundColor:"transparent",fontSize:"var(--font-size-sm)",fontFamily:"var(--font-family)",textAlign:"left",cursor:"pointer",opacity:1,transition:"var(--transition-fast)",outline:"none"},children:"Download"})]})]})}),(Re||x&&te!=="auto")&&e.jsxs("div",{style:{position:"absolute",top:"var(--space-sm)",right:"var(--space-sm)",backgroundColor:"rgba(0, 0, 0, 0.8)",color:"white",padding:"var(--space-xs) var(--space-sm)",borderRadius:"var(--radius-sm)",fontSize:"var(--font-size-xs)",fontWeight:"500",zIndex:10,opacity:Re?1:.7,transition:"opacity 0.3s ease",display:"flex",alignItems:"center",gap:"var(--space-xs)"},children:[Oe&&e.jsx("div",{style:{width:"12px",height:"12px",border:"2px solid rgba(255, 255, 255, 0.3)",borderTop:"2px solid white",borderRadius:"50%",animation:"spin 1s linear infinite"}}),Re||`${te.toUpperCase()}`]}),c&&e.jsx("div",{style:_r,children:e.jsx(V,{size:"md",variant:"primary"})})]})});H.displayName="Video";const ms={xs:"480px",sm:"640px",md:"768px",lg:"1024px",xl:"1280px",full:"100%",none:"none"},hs={start:"flex-start",center:"center",end:"flex-end",stretch:"stretch"},xs={start:"flex-start",center:"center",end:"flex-end",between:"space-between",around:"space-around",evenly:"space-evenly"},gs=h.forwardRef(({direction:s="auto",gap:a="md",padding:i="md",maxWidth:n="none",align:t="start",justify:c="start",wrap:m=!0,centered:g=!1,responsive:b=!0,className:v="",children:u,...A},f)=>{const E=ve(),x=ue(),y=()=>b?s==="auto"?x?"column":"row":s==="row"&&E==="xs"?"column":s:s,L=()=>{if(!b)return a;if(x){if(a==="xl")return"lg";if(a==="lg")return"md"}return a},N=()=>{if(!b)return i;if(x){if(i==="xl")return"lg";if(i==="lg")return"md"}return i},k=y(),M=L(),B=N(),I=()=>{const D={display:"flex",flexDirection:k,alignItems:hs[t],justifyContent:xs[c],gap:M!=="none"?`var(--space-${M})`:"0",padding:B!=="none"?`var(--space-${B})`:"0",maxWidth:ms[n],margin:g?"0 auto":"0",flexWrap:m?"wrap":"nowrap",width:"100%"};return b&&x&&(D.minHeight="auto",k==="column"&&(D.alignItems="stretch"),B!=="none"&&(D.paddingLeft=`max(var(--space-${B}), var(--mobile-safe-area-left, 0px))`,D.paddingRight=`max(var(--space-${B}), var(--mobile-safe-area-right, 0px))`,D.paddingTop=`max(var(--space-${B}), var(--mobile-safe-area-top, 0px))`,D.paddingBottom=`max(var(--space-${B}), var(--mobile-safe-area-bottom, 0px))`)),D};return e.jsx("div",{ref:f,style:I(),className:v,...A,children:u})});gs.displayName="Layout";const _=({direction:s,panels:a,gap:i="0px",style:n,className:t=""})=>{const c=s==="horizontal",m=a.map(g=>c?g.width||"1fr":g.height||"1fr").join(" ");return e.jsx("div",{className:t,style:{display:"grid",...c?{gridTemplateColumns:m}:{gridTemplateRows:m},gap:i,width:"100%",height:"100%",...n},children:a.map((g,b)=>e.jsx("div",{className:g.className,style:{overflow:"auto",...c&&g.minWidth&&{minWidth:g.minWidth},...c&&g.maxWidth&&{maxWidth:g.maxWidth},...!c&&g.minHeight&&{minHeight:g.minHeight},...!c&&g.maxHeight&&{maxHeight:g.maxHeight},...g.style},children:g.children},b))})},vs=({leftPanel:s,rightPanel:a,leftWidth:i="300px",rightWidth:n="1fr",gap:t="0px",style:c,className:m=""})=>e.jsx(_,{direction:"horizontal",panels:[{children:s,width:i},{children:a,width:n}],gap:t,style:c,className:m}),us=({leftPanel:s,centerPanel:a,rightPanel:i,leftWidth:n="250px",centerWidth:t="1fr",rightWidth:c="300px",gap:m="0px",style:g,className:b=""})=>e.jsx(_,{direction:"horizontal",panels:[{children:s,width:n},{children:a,width:t},{children:i,width:c}],gap:m,style:g,className:b}),ys=({topPanel:s,bottomPanel:a,topHeight:i="1fr",bottomHeight:n="300px",gap:t="0px",style:c,className:m=""})=>e.jsx(_,{direction:"vertical",panels:[{children:s,height:i},{children:a,height:n}],gap:t,style:c,className:m}),js=({header:s,sidebar:a,main:i,headerHeight:n="60px",sidebarWidth:t="250px",gap:c="0px",style:m,className:g=""})=>s?e.jsx(_,{direction:"vertical",panels:[{children:s,height:n},{children:e.jsx(_,{direction:"horizontal",panels:[{children:a,width:t},{children:i,width:"1fr"}],gap:c}),height:"1fr"}],gap:c,style:m,className:g}):e.jsx(_,{direction:"horizontal",panels:[{children:a,width:t},{children:i,width:"1fr"}],gap:c,style:m,className:g}),bs=({fileTree:s,editor:a,terminal:i,fileTreeWidth:n="250px",terminalHeight:t="200px",gap:c="0px",style:m,className:g=""})=>i?e.jsx(_,{direction:"horizontal",panels:[{children:s,width:n},{children:e.jsx(_,{direction:"vertical",panels:[{children:a,height:"1fr"},{children:i,height:t}],gap:c}),width:"1fr"}],gap:c,style:m,className:g}):e.jsx(_,{direction:"horizontal",panels:[{children:s,width:n},{children:a,width:"1fr"}],gap:c,style:m,className:g}),fs={sidebar:{name:"Two Panel Layout",description:"Simple two-panel layout with fixed sidebar",direction:"horizontal"},three:{name:"Three Panel Layout",description:"Three-column layout",direction:"horizontal"},dashboard:{name:"Dashboard Layout",description:"Header with sidebar and main content",direction:"horizontal"},editor:{name:"Editor Layout",description:"File tree, editor, and optional terminal",direction:"horizontal"},vertical:{name:"Vertical Layout",description:"Top and bottom panels",direction:"vertical"}},Cr=({onThemeSelect:s})=>{const a=Object.keys(ke),i=t=>({light:"Clean, professional default theme with bright backgrounds",dark:"Modern dark theme for reduced eye strain",ocean:"Calming blues and cyans for data-focused applications",forest:"Natural greens for wellness and environmental apps",sunset:"Warm oranges and pinks for creative applications",lavender:"Soft purples for elegant, dreamy interfaces",cyberpunk:"Neon highlights on dark backgrounds for tech/gaming",autumn:"Cozy browns and golds for seasonal warmth"})[t]||"Beautiful theme",n=t=>{const c=ke[t];return{primary:c.colors.accent[500],background:c.colors.background.app,surface:c.colors.background.surface,text:c.colors.text.primary}};return e.jsxs("div",{children:[e.jsxs("div",{style:{marginBottom:"var(--space-2xl)"},children:[e.jsx("h1",{style:{fontSize:"var(--font-size-3xl)",fontWeight:"var(--font-weight-bold)",margin:"0 0 var(--space-md) 0",color:"var(--text-primary)"},children:"Theme Gallery"}),e.jsx("p",{style:{fontSize:"var(--font-size-lg)",color:"var(--text-secondary)",margin:"0 0 var(--space-lg) 0",lineHeight:1.6},children:"FlowLabKit comes with 8 beautiful built-in themes. Each theme includes both light and dark variants with carefully crafted color palettes for different use cases."})]}),e.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(320px, 1fr))",gap:"var(--space-lg)",marginBottom:"var(--space-2xl)"},children:a.map(t=>{const c=n(t);return e.jsxs("div",{style:{backgroundColor:"var(--bg-surface)",border:"1px solid var(--border-color)",borderRadius:"var(--radius-lg)",padding:"var(--space-lg)",cursor:"pointer",transition:"var(--transition-base)",boxShadow:"var(--shadow-sm)"},onClick:()=>s(t),onMouseEnter:m=>{m.currentTarget.style.transform="translateY(-2px)",m.currentTarget.style.boxShadow="var(--shadow-md)"},onMouseLeave:m=>{m.currentTarget.style.transform="translateY(0)",m.currentTarget.style.boxShadow="var(--shadow-sm)"},children:[e.jsxs("div",{style:{height:"120px",borderRadius:"var(--radius-md)",marginBottom:"var(--space-md)",background:`linear-gradient(135deg, ${c.background} 0%, ${c.surface} 50%, ${c.primary}20 100%)`,border:`2px solid ${c.primary}20`,position:"relative",overflow:"hidden"},children:[e.jsxs("div",{style:{position:"absolute",top:"var(--space-sm)",right:"var(--space-sm)",display:"flex",gap:"4px"},children:[e.jsx("div",{style:{width:"16px",height:"16px",borderRadius:"50%",backgroundColor:c.primary,border:"2px solid white",boxShadow:"0 1px 3px rgba(0,0,0,0.3)"}}),e.jsx("div",{style:{width:"16px",height:"16px",borderRadius:"50%",backgroundColor:c.surface,border:"2px solid white",boxShadow:"0 1px 3px rgba(0,0,0,0.3)"}})]}),e.jsxs("div",{style:{position:"absolute",bottom:"var(--space-sm)",left:"var(--space-sm)",right:"var(--space-sm)",display:"flex",flexDirection:"column",gap:"4px"},children:[e.jsx("div",{style:{height:"8px",backgroundColor:c.primary,borderRadius:"4px",width:"60%"}}),e.jsx("div",{style:{height:"6px",backgroundColor:`${c.text}60`,borderRadius:"3px",width:"80%"}}),e.jsx("div",{style:{height:"6px",backgroundColor:`${c.text}40`,borderRadius:"3px",width:"40%"}})]})]}),e.jsxs("div",{children:[e.jsx("h3",{style:{fontSize:"var(--font-size-lg)",fontWeight:"var(--font-weight-semibold)",margin:"0 0 var(--space-xs) 0",color:"var(--text-primary)",textTransform:"capitalize"},children:t}),e.jsx("p",{style:{fontSize:"var(--font-size-sm)",color:"var(--text-secondary)",margin:"0 0 var(--space-md) 0",lineHeight:1.4},children:i(t)}),e.jsxs("button",{style:{backgroundColor:c.primary,color:"white",border:"none",borderRadius:"var(--radius-sm)",padding:"var(--space-sm) var(--space-md)",fontSize:"var(--font-size-sm)",fontWeight:"var(--font-weight-medium)",cursor:"pointer",transition:"var(--transition-fast)"},children:["Try ",t]})]})]},t)})}),e.jsxs("div",{style:{backgroundColor:"var(--bg-surface)",border:"1px solid var(--border-color)",borderRadius:"var(--radius-lg)",padding:"var(--space-xl)"},children:[e.jsx("h2",{style:{fontSize:"var(--font-size-xl)",fontWeight:"var(--font-weight-semibold)",margin:"0 0 var(--space-lg) 0",color:"var(--text-primary)"},children:"Quick Start"}),e.jsx("pre",{style:{backgroundColor:"var(--bg-elevated)",border:"1px solid var(--border-color)",borderRadius:"var(--radius-md)",padding:"var(--space-lg)",fontSize:"var(--font-size-sm)",color:"var(--text-primary)",overflow:"auto",fontFamily:'Monaco, Consolas, "Liberation Mono", "Courier New", monospace'},children:`import { ThemeProvider } from '@flowlabkit/ui';
...
<Input placeholder="Error" isInvalid />`}),e.jsx(t,{title:"Badge",description:"Small status indicators and labels with various styles",demos:{Variants:e.jsxs(e.Fragment,{children:[e.jsx(p,{variant:"default",children:"Default"}),e.jsx(p,{variant:"primary",children:"Primary"}),e.jsx(p,{variant:"secondary",children:"Secondary"}),e.jsx(p,{variant:"success",children:"Success"}),e.jsx(p,{variant:"warning",children:"Warning"}),e.jsx(p,{variant:"error",children:"Error"}),e.jsx(p,{variant:"info",children:"Info"})]}),Sizes:e.jsxs(e.Fragment,{children:[e.jsx(p,{variant:"primary",size:"sm",children:"Small"}),e.jsx(p,{variant:"primary",size:"md",children:"Medium"}),e.jsx(p,{variant:"primary",size:"lg",children:"Large"})]}),Shapes:e.jsxs(e.Fragment,{children:[e.jsx(p,{variant:"primary",children:"Default"}),e.jsx(p,{variant:"primary",shape:"pill",children:"Pill"}),e.jsx(p,{variant:"primary",shape:"square",children:"Square"}),e.jsx(p,{variant:"primary",dot:!0,children:"Dot"})]})},code:`<Badge variant="default">Default</Badge>
...
<Spinner speed="fast" />`}),e.jsx(t,{title:"LoadingIndicator",description:"Advanced loading animations with text labels and multiple animation types",demos:{Types:e.jsxs(e.Fragment,{children:[e.jsx(P,{type:"dots",text:"Loading",variant:"accent"}),e.jsx(P,{type:"pulse",text:"Processing",variant:"primary"}),e.jsx(P,{type:"wave",text:"Uploading",variant:"success"}),e.jsx(P,{type:"bars",text:"Analyzing",variant:"warning"}),e.jsx(P,{type:"bounce",text:"Syncing",variant:"error"})]}),Variants:e.jsxs(e.Fragment,{children:[e.jsx(P,{type:"dots",text:"Primary",variant:"primary"}),e.jsx(P,{type:"dots",text:"Accent",variant:"accent"}),e.jsx(P,{type:"dots",text:"Success",variant:"success"}),e.jsx(P,{type:"dots",text:"Warning",variant:"warning"}),e.jsx(P,{type:"dots",text:"Error",variant:"error"})]}),Sizes:e.jsxs(e.Fragment,{children:[e.jsx(P,{type:"wave",size:"sm",variant:"success"}),e.jsx(P,{type:"wave",size:"md",variant:"success"}),e.jsx(P,{type:"wave",size:"lg",variant:"success"})]}),States:e.jsxs(e.Fragment,{children:[e.jsx(P,{type:"dots",text:"Above",textPosition:"top",variant:"accent"}),e.jsx(P,{type:"pulse",text:"Below",textPosition:"bottom",variant:"primary"}),e.jsx(P,{type:"bounce",text:"Left",textPosition:"left",variant:"warning"}),e.jsx(P,{type:"bars",text:"Right",textPosition:"right",variant:"error"})]})},code:`<LoadingIndicator type="dots" text="Loading" variant="accent" />
...
<Video fit="cover" />
<Video autoPlay muted loop />`}),e.jsx(t,{title:"Card",description:"Container component with header, body, and footer sections",demos:{Variants:e.jsxs(e.Fragment,{children:[e.jsxs(o,{style:{width:"200px"},children:[e.jsxs(T,{children:[e.jsx(r,{as:"h3",size:"md",weight:"semibold",children:"Full Card"}),e.jsx(r,{as:"p",size:"sm",color:"secondary",children:"With all sections"})]}),e.jsx(d,{children:e.jsx(r,{as:"p",size:"sm",children:"This card has header, body, and footer sections."})}),e.jsx(_e,{children:e.jsx(j,{variant:"primary",size:"sm",children:"Action"})})]}),e.jsx(o,{style:{width:"200px"},children:e.jsx(d,{children:e.jsx(r,{as:"p",size:"sm",children:"Simple card with body only."})})})]}),States:e.jsxs(e.Fragment,{children:[e.jsxs(o,{style:{width:"180px"},children:[e.jsx(T,{children:e.jsx(r,{as:"h3",size:"sm",weight:"semibold",children:"Normal Card"})}),e.jsx(d,{children:e.jsx(r,{as:"p",size:"xs",children:"Standard appearance"})})]}),e.jsxs(o,{style:{width:"180px",opacity:.6},children:[e.jsx(T,{children:e.jsx(r,{as:"h3",size:"sm",weight:"semibold",children:"Disabled Card"})}),e.jsx(d,{children:e.jsx(r,{as:"p",size:"xs",children:"Disabled appearance"})})]})]})},code:`<Card>
  <CardHeader>
...
>
  Delete Account
</Button>`})]})}),e.jsx(o,{children:e.jsxs(d,{children:[e.jsx(r,{as:"h2",size:"xl",weight:"semibold",style:{marginBottom:"var(--space-md)"},children:"Styling & Customization"}),e.jsx(r,{as:"h3",size:"lg",weight:"medium",style:{marginBottom:"var(--space-sm)"},children:"CSS Variables"}),e.jsx(r,{as:"p",size:"md",style:{marginBottom:"var(--space-md)",lineHeight:"1.6"},children:"Button components use theme CSS variables that can be customized:"}),e.jsx(Be,{language:"css",children:`.custom-button {
  /* Background colors */
...
<fieldset>
  ...
  <Input type="email" placeholder="Email" />
</fieldset>`})]})})]})},Ae=({children:s,language:a="tsx"})=>e.jsx("pre",{style:{backgroundColor:"var(--bg-elevated)",color:"var(--text-primary)",padding:"var(--space-lg)",borderRadius:"var(--radius-md)",border:"1px solid var(--border-color)",overflow:"auto",fontSize:"var(--font-size-sm)",fontFamily:"Consolas, Monaco, 'Courier New', monospace",margin:"var(--space-md) 0",lineHeight:"1.5"},children:e.jsx("code",{children:s})}),Xe=({title:s,children:a})=>e.jsxs("div",{style:{marginBottom:"var(--space-lg)"},children:[e.jsx(r,{as:"h4",size:"md",weight:"medium",style:{marginBottom:"var(--space-sm)"},children:s}),e.jsx("div",{style:{padding:"var(--space-md)",backgroundColor:"var(--bg-surface)",borderRadius:"var(--radius-sm)",border:"1px solid var(--border-color)",display:"flex",flexWrap:"wrap",gap:"var(--space-sm)",alignItems:"center"},children:a})]}),Ls=()=>e.jsxs("div",{children:[e.jsxs("div",{style:{marginBottom:"var(--space-xl)"},children:[e.jsx(r,{as:"h1",size:"3xl",weight:"bold",style:{marginBottom:"var(--space-sm)"},children:"Badge"}),e.jsx(r,{as:"p",size:"lg",color:"secondary",children:"Small status descriptors for labeling, categorizing, and displaying metadata"})]}),e.jsx(o,{style:{marginBottom:"var(--space-xl)"},children:e.jsxs(d,{children:[e.jsx(r,{as:"h2",size:"xl",weight:"semibold",style:{marginBottom:"var(--space-md)"},children:"Overview"}),e.jsx(r,{as:"p",size:"md",style:{marginBottom:"var(--space-lg)",lineHeight:"1.6"},children:"Badges are small components used to display status, notifications, or metadata. They're perfect for showing counts, labels, categories, or any short piece of information that needs to stand out from the main content."}),e.jsxs("div",{style:{display:"flex",gap:"var(--space-md)",flexWrap:"wrap"},children:[e.jsx(p,{variant:"primary",children:"7 Variants"}),e.jsx(p,{variant:"success",children:"3 Sizes"}),e.jsx(p,{variant:"info",children:"3 Shapes"}),e.jsx(p,{variant:"secondary",children:"Flexible Content"})]})]})}),e.jsx(o,{style:{marginBottom:"var(--space-xl)"},children:e.jsxs(d,{children:[e.jsx(r,{as:"h2",size:"xl",weight:"semibold",style:{marginBottom:"var(--space-md)"},children:"Examples"}),e.jsxs(Xe,{title:"Variants",children:[e.jsx(p,{variant:"default",children:"Default"}),e.jsx(p,{variant:"primary",children:"Primary"}),e.jsx(p,{variant:"secondary",children:"Secondary"}),e.jsx(p,{variant:"success",children:"Success"}),e.jsx(p,{variant:"warning",children:"Warning"}),e.jsx(p,{variant:"error",children:"Error"}),e.jsx(p,{variant:"info",children:"Info"})]}),e.jsxs(Xe,{title:"Sizes",children:[e.jsx(p,{size:"sm",children:"Small Badge"}),e.jsx(p,{size:"md",children:"Medium Badge"}),e.jsx(p,{size:"lg",children:"Large Badge"})]}),e.jsxs(Xe,{title:"Shapes",children:[e.jsx(p,{shape:"rounded",children:"Rounded"}),e.jsx(p,{shape:"square",children:"Square"}),e.jsx(p,{shape:"pill",children:"Pill Shape"}),e.jsx(p,{dot:!0,size:"md",variant:"primary"})]}),e.jsx(Xe,{title:"Real-world Usage",children:e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"var(--space-md)"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"var(--space-sm)"},children:[e.jsx(r,{children:"Messages"}),e.jsx(p,{variant:"primary",shape:"pill",size:"sm",children:"3"})]}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"var(--space-sm)"},children:[e.jsx(r,{children:"Status:"}),e.jsx(p,{variant:"success",size:"sm",children:"Active"})]}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"var(--space-sm)"},children:[e.jsx(r,{children:"Priority:"}),e.jsx(p,{variant:"error",size:"sm",children:"High"})]}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"var(--space-sm)"},children:[e.jsx(r,{children:"Version:"}),e.jsx(p,{variant:"info",shape:"pill",children:"v2.1.0"})]})]})})]})}),e.jsx(o,{style:{marginBottom:"var(--space-xl)"},children:e.jsxs(d,{children:[e.jsx(r,{as:"h2",size:"xl",weight:"semibold",style:{marginBottom:"var(--space-md)"},children:"API Reference"}),e.jsx(r,{as:"h3",size:"lg",weight:"medium",style:{marginBottom:"var(--space-sm)"},children:"Props"}),e.jsx("div",{style:{overflowX:"auto"},children:e.jsxs("table",{style:{width:"100%",borderCollapse:"collapse",backgroundColor:"var(--bg-elevated)",borderRadius:"var(--radius-md)",overflow:"hidden"},children:[e.jsx("thead",{children:e.jsxs("tr",{style:{backgroundColor:"var(--bg-surface)"},children:[e.jsx("th",{style:{padding:"var(--space-md)",textAlign:"left",borderBottom:"1px solid var(--border-color)",fontWeight:"var(--font-weight-semibold)"},children:"Prop"}),e.jsx("th",{style:{padding:"var(--space-md)",textAlign:"left",borderBottom:"1px solid var(--border-color)",fontWeight:"var(--font-weight-semibold)"},children:"Type"}),e.jsx("th",{style:{padding:"var(--space-md)",textAlign:"left",borderBottom:"1px solid var(--border-color)",fontWeight:"var(--font-weight-semibold)"},children:"Default"}),e.jsx("th",{style:{padding:"var(--space-md)",textAlign:"left",borderBottom:"1px solid var(--border-color)",fontWeight:"var(--font-weight-semibold)"},children:"Description"})]})}),e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"variant"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"'default' | 'primary' | 'secondary' | 'success' | 'warning' | 'error' | 'info'"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"'default'"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:"Visual style variant affecting color scheme"})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"size"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"'sm' | 'md' | 'lg'"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"'md'"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:"Size of the badge affecting padding and font size"})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"shape"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"'rounded' | 'square' | 'pill'"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"'rounded'"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:"Shape style of the badge corners"})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"dot"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"boolean"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"false"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:"Renders as a circular dot without content"})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"children"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"React.ReactNode"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"undefined"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:"Content to display inside the badge"})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"className"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"string"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"undefined"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:"Additional CSS class names for custom styling"})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"var(--space-md)"},children:e.jsx("code",{children:"style"})}),e.jsx("td",{style:{padding:"var(--space-md)"},children:e.jsx("code",{children:"React.CSSProperties"})}),e.jsx("td",{style:{padding:"var(--space-md)"},children:e.jsx("code",{children:"undefined"})}),e.jsx("td",{style:{padding:"var(--space-md)"},children:"Inline styles for custom styling"})]})]})]})})]})}),e.jsx(o,{style:{marginBottom:"var(--space-xl)"},children:e.jsxs(d,{children:[e.jsx(r,{as:"h2",size:"xl",weight:"semibold",style:{marginBottom:"var(--space-md)"},children:"Usage Examples"}),e.jsx(r,{as:"h3",size:"lg",weight:"medium",style:{marginBottom:"var(--space-sm)"},children:"Notification Badges"}),e.jsx(Ae,{children:`import { Badge, Text } from '@flowlabkit/ui';
...
</nav>`})]})})]}),He=({children:s,language:a="tsx"})=>e.jsx("pre",{style:{backgroundColor:"var(--bg-elevated)",color:"var(--text-primary)",padding:"var(--space-lg)",borderRadius:"var(--radius-md)",border:"1px solid var(--border-color)",overflow:"auto",fontSize:"var(--font-size-sm)",fontFamily:"Consolas, Monaco, 'Courier New', monospace",margin:"var(--space-md) 0",lineHeight:"1.5"},children:e.jsx("code",{children:s})}),Ge=({title:s,children:a})=>e.jsxs("div",{style:{marginBottom:"var(--space-lg)"},children:[e.jsx(r,{as:"h4",size:"md",weight:"medium",style:{marginBottom:"var(--space-sm)"},children:s}),e.jsx("div",{style:{padding:"var(--space-md)",backgroundColor:"var(--bg-surface)",borderRadius:"var(--radius-sm)",border:"1px solid var(--border-color)",display:"flex",flexWrap:"wrap",gap:"var(--space-md)",alignItems:"center"},children:a})]}),Ps=()=>e.jsxs("div",{children:[e.jsxs("div",{style:{marginBottom:"var(--space-xl)"},children:[e.jsx(r,{as:"h1",size:"3xl",weight:"bold",style:{marginBottom:"var(--space-sm)"},children:"Spinner"}),e.jsx(r,{as:"p",size:"lg",color:"secondary",children:"Loading spinner component for indicating async operations and loading states"})]}),e.jsx(o,{style:{marginBottom:"var(--space-xl)"},children:e.jsxs(d,{children:[e.jsx(r,{as:"h2",size:"xl",weight:"semibold",style:{marginBottom:"var(--space-md)"},children:"Overview"}),e.jsx(r,{as:"p",size:"md",style:{marginBottom:"var(--space-lg)",lineHeight:"1.6"},children:"The Spinner component provides visual feedback for loading states with multiple variants, sizes, and animation options. Perfect for indicating data fetching, form submissions, or any async operations."}),e.jsxs("div",{style:{display:"flex",gap:"var(--space-md)",flexWrap:"wrap"},children:[e.jsx(p,{variant:"primary",children:"6 Variants"}),e.jsx(p,{variant:"success",children:"5 Sizes"}),e.jsx(p,{variant:"info",children:"3 Thickness Options"}),e.jsx(p,{variant:"secondary",children:"3 Speed Settings"})]})]})}),e.jsx(o,{style:{marginBottom:"var(--space-xl)"},children:e.jsxs(d,{children:[e.jsx(r,{as:"h2",size:"xl",weight:"semibold",style:{marginBottom:"var(--space-md)"},children:"Examples"}),e.jsxs(Ge,{title:"Variants",children:[e.jsx(V,{variant:"primary"}),e.jsx(V,{variant:"accent"}),e.jsx(V,{variant:"success"}),e.jsx(V,{variant:"warning"}),e.jsx(V,{variant:"error"}),e.jsx(V,{variant:"secondary"})]}),e.jsxs(Ge,{title:"Sizes",children:[e.jsx(V,{variant:"accent",size:"xs"}),e.jsx(V,{variant:"accent",size:"sm"}),e.jsx(V,{variant:"accent",size:"md"}),e.jsx(V,{variant:"accent",size:"lg"}),e.jsx(V,{variant:"accent",size:"xl"})]}),e.jsxs(Ge,{title:"Thickness Options",children:[e.jsx(V,{variant:"accent",thickness:"thin"}),e.jsx(V,{variant:"accent",thickness:"medium"}),e.jsx(V,{variant:"accent",thickness:"thick"})]}),e.jsxs(Ge,{title:"Speed Settings",children:[e.jsx(V,{variant:"accent",speed:"slow"}),e.jsx(V,{variant:"accent",speed:"normal"}),e.jsx(V,{variant:"accent",speed:"fast"})]})]})}),e.jsx(o,{style:{marginBottom:"var(--space-xl)"},children:e.jsxs(d,{children:[e.jsx(r,{as:"h2",size:"xl",weight:"semibold",style:{marginBottom:"var(--space-md)"},children:"API Reference"}),e.jsx(r,{as:"h3",size:"lg",weight:"medium",style:{marginBottom:"var(--space-sm)"},children:"Props"}),e.jsx("div",{style:{overflowX:"auto"},children:e.jsxs("table",{style:{width:"100%",borderCollapse:"collapse",backgroundColor:"var(--bg-elevated)",borderRadius:"var(--radius-md)",overflow:"hidden"},children:[e.jsx("thead",{children:e.jsxs("tr",{style:{backgroundColor:"var(--bg-surface)"},children:[e.jsx("th",{style:{padding:"var(--space-md)",textAlign:"left",borderBottom:"1px solid var(--border-color)",fontWeight:"var(--font-weight-semibold)"},children:"Prop"}),e.jsx("th",{style:{padding:"var(--space-md)",textAlign:"left",borderBottom:"1px solid var(--border-color)",fontWeight:"var(--font-weight-semibold)"},children:"Type"}),e.jsx("th",{style:{padding:"var(--space-md)",textAlign:"left",borderBottom:"1px solid var(--border-color)",fontWeight:"var(--font-weight-semibold)"},children:"Default"}),e.jsx("th",{style:{padding:"var(--space-md)",textAlign:"left",borderBottom:"1px solid var(--border-color)",fontWeight:"var(--font-weight-semibold)"},children:"Description"})]})}),e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"variant"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"'primary' | 'secondary' | 'accent' | 'success' | 'warning' | 'error'"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"'primary'"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:"Color variant of the spinner"})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"size"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"'xs' | 'sm' | 'md' | 'lg' | 'xl'"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"'md'"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:"Size of the spinner (16px to 48px)"})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"thickness"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"'thin' | 'medium' | 'thick'"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"'medium'"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:"Thickness of the spinner border"})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"speed"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"'slow' | 'normal' | 'fast'"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"'normal'"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:"Animation speed (2s, 1s, 0.5s)"})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"className"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"string"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"undefined"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:"Additional CSS class names for custom styling"})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"var(--space-md)"},children:e.jsx("code",{children:"style"})}),e.jsx("td",{style:{padding:"var(--space-md)"},children:e.jsx("code",{children:"React.CSSProperties"})}),e.jsx("td",{style:{padding:"var(--space-md)"},children:e.jsx("code",{children:"undefined"})}),e.jsx("td",{style:{padding:"var(--space-md)"},children:"Inline styles for custom styling"})]})]})]})})]})}),e.jsx(o,{style:{marginBottom:"var(--space-xl)"},children:e.jsxs(d,{children:[e.jsx(r,{as:"h2",size:"xl",weight:"semibold",style:{marginBottom:"var(--space-md)"},children:"Usage Examples"}),e.jsx(r,{as:"h3",size:"lg",weight:"medium",style:{marginBottom:"var(--space-sm)"},children:"Basic Usage"}),e.jsx(He,{children:`import { Spinner } from '@flowlabkit/ui';
...
}`})]})})]}),ze=({children:s,language:a="tsx"})=>e.jsx("pre",{style:{backgroundColor:"var(--bg-elevated)",color:"var(--text-primary)",padding:"var(--space-lg)",borderRadius:"var(--radius-md)",border:"1px solid var(--border-color)",overflow:"auto",fontSize:"var(--font-size-sm)",fontFamily:"Consolas, Monaco, 'Courier New', monospace",margin:"var(--space-md) 0",lineHeight:"1.5"},children:e.jsx("code",{children:s})}),Ce=({title:s,children:a})=>e.jsxs("div",{style:{marginBottom:"var(--space-lg)"},children:[e.jsx(r,{as:"h4",size:"md",weight:"medium",style:{marginBottom:"var(--space-sm)"},children:s}),e.jsx("div",{style:{padding:"var(--space-md)",backgroundColor:"var(--bg-surface)",borderRadius:"var(--radius-sm)",border:"1px solid var(--border-color)",display:"flex",flexWrap:"wrap",gap:"var(--space-lg)",alignItems:"center",justifyContent:"center"},children:a})]}),As=()=>e.jsxs("div",{children:[e.jsxs("div",{style:{marginBottom:"var(--space-xl)"},children:[e.jsx(r,{as:"h1",size:"3xl",weight:"bold",style:{marginBottom:"var(--space-sm)"},children:"LoadingIndicator"}),e.jsx(r,{as:"p",size:"lg",color:"secondary",children:"Advanced loading animations with customizable types, text positioning, and visual styles"})]}),e.jsx(o,{style:{marginBottom:"var(--space-xl)"},children:e.jsxs(d,{children:[e.jsx(r,{as:"h2",size:"xl",weight:"semibold",style:{marginBottom:"var(--space-md)"},children:"Overview"}),e.jsx(r,{as:"p",size:"md",style:{marginBottom:"var(--space-lg)",lineHeight:"1.6"},children:"The LoadingIndicator component provides a rich set of animated loading states perfect for indicating progress, data fetching, or processing operations. It supports multiple animation types, text integration, and comprehensive customization options."}),e.jsxs("div",{style:{display:"flex",gap:"var(--space-md)",flexWrap:"wrap"},children:[e.jsx(p,{variant:"primary",children:"5 Animation Types"}),e.jsx(p,{variant:"success",children:"5 Sizes"}),e.jsx(p,{variant:"info",children:"6 Color Variants"}),e.jsx(p,{variant:"secondary",children:"Text Integration"})]})]})}),e.jsx(o,{style:{marginBottom:"var(--space-xl)"},children:e.jsxs(d,{children:[e.jsx(r,{as:"h2",size:"xl",weight:"semibold",style:{marginBottom:"var(--space-md)"},children:"Examples"}),e.jsx(Ce,{title:"Animation Types",children:e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"var(--space-md)",alignItems:"center"},children:[e.jsx(P,{type:"dots",text:"Dots"}),e.jsx(P,{type:"pulse",text:"Pulse"}),e.jsx(P,{type:"wave",text:"Wave"}),e.jsx(P,{type:"bars",text:"Bars"}),e.jsx(P,{type:"bounce",text:"Bounce"})]})}),e.jsx(Ce,{title:"Sizes",children:e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"var(--space-lg)"},children:[e.jsx(P,{size:"xs",text:"XS"}),e.jsx(P,{size:"sm",text:"SM"}),e.jsx(P,{size:"md",text:"MD"}),e.jsx(P,{size:"lg",text:"LG"}),e.jsx(P,{size:"xl",text:"XL"})]})}),e.jsx(Ce,{title:"Color Variants",children:e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"var(--space-md)",alignItems:"center"},children:[e.jsx(P,{variant:"primary",text:"Primary"}),e.jsx(P,{variant:"secondary",text:"Secondary"}),e.jsx(P,{variant:"accent",text:"Accent"}),e.jsx(P,{variant:"success",text:"Success"}),e.jsx(P,{variant:"warning",text:"Warning"}),e.jsx(P,{variant:"error",text:"Error"})]})}),e.jsx(Ce,{title:"Animation Speed",children:e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"var(--space-lg)"},children:[e.jsx(P,{speed:"slow",text:"Slow"}),e.jsx(P,{speed:"normal",text:"Normal"}),e.jsx(P,{speed:"fast",text:"Fast"})]})}),e.jsx(Ce,{title:"Text Positioning",children:e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"var(--space-lg)",alignItems:"center",width:"100%"},children:[e.jsx(P,{textPosition:"left",text:"Loading..."}),e.jsx(P,{textPosition:"right",text:"Loading..."}),e.jsx(P,{textPosition:"top",text:"Loading..."}),e.jsx(P,{textPosition:"bottom",text:"Loading..."})]})}),e.jsx(Ce,{title:"Real-world Usage",children:e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"var(--space-lg)",width:"100%"},children:[e.jsx(o,{variant:"outlined",style:{padding:"var(--space-lg)",textAlign:"center"},children:e.jsx(P,{type:"wave",variant:"primary",size:"lg",text:"Fetching user data...",textPosition:"bottom"})}),e.jsx(o,{variant:"filled",style:{padding:"var(--space-lg)",textAlign:"center"},children:e.jsx(P,{type:"bounce",variant:"success",size:"md",text:"Processing payment...",textPosition:"right",speed:"fast"})}),e.jsx(o,{variant:"elevated",style:{padding:"var(--space-lg)",textAlign:"center"},children:e.jsx(P,{type:"bars",variant:"accent",size:"sm",text:"Uploading files...",textPosition:"left"})})]})})]})}),e.jsx(o,{style:{marginBottom:"var(--space-xl)"},children:e.jsxs(d,{children:[e.jsx(r,{as:"h2",size:"xl",weight:"semibold",style:{marginBottom:"var(--space-md)"},children:"API Reference"}),e.jsx(r,{as:"h3",size:"lg",weight:"medium",style:{marginBottom:"var(--space-sm)"},children:"Props"}),e.jsx("div",{style:{overflowX:"auto"},children:e.jsxs("table",{style:{width:"100%",borderCollapse:"collapse",backgroundColor:"var(--bg-elevated)",borderRadius:"var(--radius-md)",overflow:"hidden"},children:[e.jsx("thead",{children:e.jsxs("tr",{style:{backgroundColor:"var(--bg-surface)"},children:[e.jsx("th",{style:{padding:"var(--space-md)",textAlign:"left",borderBottom:"1px solid var(--border-color)",fontWeight:"var(--font-weight-semibold)"},children:"Prop"}),e.jsx("th",{style:{padding:"var(--space-md)",textAlign:"left",borderBottom:"1px solid var(--border-color)",fontWeight:"var(--font-weight-semibold)"},children:"Type"}),e.jsx("th",{style:{padding:"var(--space-md)",textAlign:"left",borderBottom:"1px solid var(--border-color)",fontWeight:"var(--font-weight-semibold)"},children:"Default"}),e.jsx("th",{style:{padding:"var(--space-md)",textAlign:"left",borderBottom:"1px solid var(--border-color)",fontWeight:"var(--font-weight-semibold)"},children:"Description"})]})}),e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"type"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"'dots' | 'pulse' | 'wave' | 'bars' | 'bounce'"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"'dots'"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:"Animation type for the loading indicator"})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"size"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"'xs' | 'sm' | 'md' | 'lg' | 'xl'"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"'md'"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:"Size of the loading animation elements"})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"variant"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"'primary' | 'secondary' | 'accent' | 'success' | 'warning' | 'error'"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"'primary'"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:"Color variant from the theme system"})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"speed"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"'slow' | 'normal' | 'fast'"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"'normal'"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:"Animation speed timing"})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"text"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"string"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"undefined"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:"Optional text to display with the loading animation"})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"textPosition"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"'left' | 'right' | 'top' | 'bottom'"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"'right'"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:"Position of text relative to the animation"})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"className"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"string"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"undefined"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:"Additional CSS class names for custom styling"})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"var(--space-md)"},children:e.jsx("code",{children:"style"})}),e.jsx("td",{style:{padding:"var(--space-md)"},children:e.jsx("code",{children:"React.CSSProperties"})}),e.jsx("td",{style:{padding:"var(--space-md)"},children:e.jsx("code",{children:"undefined"})}),e.jsx("td",{style:{padding:"var(--space-md)"},children:"Inline styles for custom styling"})]})]})]})})]})}),e.jsx(o,{style:{marginBottom:"var(--space-xl)"},children:e.jsxs(d,{children:[e.jsx(r,{as:"h2",size:"xl",weight:"semibold",style:{marginBottom:"var(--space-md)"},children:"Usage Examples"}),e.jsx(r,{as:"h3",size:"lg",weight:"medium",style:{marginBottom:"var(--space-sm)"},children:"Data Fetching States"}),e.jsx(ze,{children:`import { LoadingIndicator } from '@flowlabkit/ui';
...
/>`})]})]}),e.jsxs(o,{children:[e.jsx(T,{children:e.jsx(r,{as:"h3",size:"lg",weight:"semibold",children:"All Advanced Features"})}),e.jsxs(d,{children:[e.jsxs("div",{style:{display:"flex",gap:"var(--space-lg)",alignItems:"center",marginBottom:"var(--space-lg)"},children:[e.jsx(H,{src:R,size:"sm",enableFullscreen:!0,enableLoop:!0,showPlaybackSpeed:!0,showVideoQuality:!0,videoQualities:$,enableDownload:!0,poster:"https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/images/BigBuckBunny.jpg"}),e.jsxs(r,{size:"sm",color:"secondary",style:{flex:1},children:["A fully-featured video player with all advanced options enabled.",e.jsx("strong",{children:"Quality testing ready:"})," Use the 3-dot menu → Quality to test YouTube-style quality switching. Watch the top-right corner for quality indicators and loading feedback when switching between 1080p, 720p, 480p, 360p, and 240p."]})]}),e.jsx(r,{size:"sm",weight:"medium",style:{fontFamily:"monospace",backgroundColor:"var(--bg-secondary)",padding:"var(--space-sm)",borderRadius:"var(--radius-sm)"},children:`<Video 
  ...
  enableDownload 
/>`})]})]})]})]}),e.jsxs("div",{style:{marginBottom:"var(--space-2xl)"},children:[e.jsx(r,{as:"h2",size:"2xl",weight:"bold",style:{marginBottom:"var(--space-lg)"},children:"Usage Guidelines"}),e.jsxs("div",{style:{display:"grid",gap:"var(--space-lg)"},children:[e.jsxs(o,{children:[e.jsx(T,{children:e.jsx(r,{as:"h3",size:"lg",weight:"semibold",style:{color:"var(--success-600)"},children:"[[✓]] Do"})}),e.jsx(d,{children:e.jsxs("ul",{style:{margin:0,paddingLeft:"var(--space-lg)"},children:[e.jsx("li",{style:{marginBottom:"var(--space-sm)"},children:e.jsx(r,{size:"sm",children:"Provide poster images for better loading experience"})}),e.jsx("li",{style:{marginBottom:"var(--space-sm)"},children:e.jsx(r,{size:"sm",children:"Use appropriate sizes for your layout context"})}),e.jsx("li",{style:{marginBottom:"var(--space-sm)"},children:e.jsx(r,{size:"sm",children:"Include meaningful alt text for accessibility"})}),e.jsx("li",{style:{marginBottom:"var(--space-sm)"},children:e.jsx(r,{size:"sm",children:"Handle error states with custom fallbacks when needed"})}),e.jsx("li",{children:e.jsx(r,{size:"sm",children:"Consider autoplay policies when using video"})})]})})]}),e.jsxs(o,{children:[e.jsx(T,{children:e.jsx(r,{as:"h3",size:"lg",weight:"semibold",style:{color:"var(--danger-600)"},children:"[✗] Don't"})}),e.jsx(d,{children:e.jsxs("ul",{style:{margin:0,paddingLeft:"var(--space-lg)"},children:[e.jsx("li",{style:{marginBottom:"var(--space-sm)"},children:e.jsx(r,{size:"sm",children:"Use oversized videos that impact performance"})}),e.jsx("li",{style:{marginBottom:"var(--space-sm)"},children:e.jsx(r,{size:"sm",children:"Forget to provide fallback content for accessibility"})}),e.jsx("li",{style:{marginBottom:"var(--space-sm)"},children:e.jsx(r,{size:"sm",children:"Auto-play videos with sound without user consent"})}),e.jsx("li",{children:e.jsx(r,{size:"sm",children:"Use for complex video player needs - consider FlowLabKit's advanced Video component"})})]})})]})]})]}),e.jsxs(o,{children:[e.jsx(T,{children:e.jsx(r,{as:"h2",size:"xl",weight:"semibold",children:"Accessibility"})}),e.jsx(d,{children:e.jsxs("div",{style:{display:"grid",gap:"var(--space-md)"},children:[e.jsxs("div",{children:[e.jsx(r,{size:"sm",weight:"medium",style:{marginBottom:"var(--space-xs)"},children:"Keyboard Navigation"}),e.jsx(r,{size:"sm",color:"secondary",children:"Video controls are keyboard accessible when enabled. Users can play/pause with Space, and navigate with arrow keys."})]}),e.jsxs("div",{children:[e.jsx(r,{size:"sm",weight:"medium",style:{marginBottom:"var(--space-xs)"},children:"Screen Readers"}),e.jsx(r,{size:"sm",color:"secondary",children:"Provide meaningful descriptions and consider captions for video content."})]}),e.jsxs("div",{children:[e.jsx(r,{size:"sm",weight:"medium",style:{marginBottom:"var(--space-xs)"},children:"Motion Sensitivity"}),e.jsx(r,{size:"sm",color:"secondary",children:"Respect user preferences for reduced motion and avoid auto-playing videos."})]}),e.jsxs("div",{children:[e.jsx(r,{size:"sm",weight:"medium",style:{marginBottom:"var(--space-xs)"},children:"Error Handling"}),e.jsx(r,{size:"sm",color:"secondary",children:"Graceful error states ensure the interface remains accessible when videos fail to load."})]})]})})]})]})},Ne=({children:s,language:a="tsx"})=>e.jsx("pre",{style:{backgroundColor:"var(--bg-elevated)",color:"var(--text-primary)",padding:"var(--space-lg)",borderRadius:"var(--radius-md)",border:"1px solid var(--border-color)",overflow:"auto",fontSize:"var(--font-size-sm)",fontFamily:"Consolas, Monaco, 'Courier New', monospace",margin:"var(--space-md) 0",lineHeight:"1.5"},children:e.jsx("code",{children:s})}),Qe=({title:s,children:a})=>e.jsxs("div",{style:{marginBottom:"var(--space-lg)"},children:[e.jsx(r,{as:"h4",size:"md",weight:"medium",style:{marginBottom:"var(--space-sm)"},children:s}),e.jsx("div",{style:{padding:"var(--space-md)",backgroundColor:"var(--bg-surface)",borderRadius:"var(--radius-sm)",border:"1px solid var(--border-color)",display:"flex",flexDirection:"column",gap:"var(--space-md)"},children:a})]}),Ws=()=>e.jsxs("div",{children:[e.jsxs("div",{style:{marginBottom:"var(--space-xl)"},children:[e.jsx(r,{as:"h1",size:"3xl",weight:"bold",style:{marginBottom:"var(--space-sm)"},children:"Card"}),e.jsx(r,{as:"p",size:"lg",color:"secondary",children:"Flexible container component for grouping related content with header, body, and footer sections"})]}),e.jsx(o,{style:{marginBottom:"var(--space-xl)"},children:e.jsxs(d,{children:[e.jsx(r,{as:"h2",size:"xl",weight:"semibold",style:{marginBottom:"var(--space-md)"},children:"Overview"}),e.jsx(r,{as:"p",size:"md",style:{marginBottom:"var(--space-lg)",lineHeight:"1.6"},children:"The Card component system provides a flexible foundation for content layout. It includes Card, CardHeader, CardBody, and CardFooter components that can be composed together to create structured, visually appealing content containers."}),e.jsxs("div",{style:{display:"flex",gap:"var(--space-md)",flexWrap:"wrap"},children:[e.jsx(p,{variant:"primary",children:"Modular Design"}),e.jsx(p,{variant:"success",children:"Multiple Variants"}),e.jsx(p,{variant:"info",children:"Flexible Layout"}),e.jsx(p,{variant:"secondary",children:"Composable"})]})]})}),e.jsx(o,{style:{marginBottom:"var(--space-xl)"},children:e.jsxs(d,{children:[e.jsx(r,{as:"h2",size:"xl",weight:"semibold",style:{marginBottom:"var(--space-md)"},children:"Examples"}),e.jsx(Qe,{title:"Basic Cards",children:e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(250px, 1fr))",gap:"var(--space-md)"},children:[e.jsx(o,{children:e.jsxs(d,{children:[e.jsx(r,{as:"h3",size:"lg",weight:"semibold",style:{marginBottom:"var(--space-sm)"},children:"Simple Card"}),e.jsx(r,{children:"This is a basic card with just a body section containing some content."})]})}),e.jsxs(o,{variant:"outlined",children:[e.jsx(T,{children:e.jsx(r,{as:"h3",size:"lg",weight:"semibold",children:"Outlined Card"})}),e.jsx(d,{children:e.jsx(r,{children:"This card has a visible border and includes both header and body sections."})})]})]})}),e.jsx(Qe,{title:"Card Variants",children:e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(200px, 1fr))",gap:"var(--space-md)"},children:[e.jsx(o,{variant:"elevated",children:e.jsxs(d,{children:[e.jsx(r,{weight:"medium",children:"Elevated"}),e.jsx(r,{size:"sm",color:"secondary",children:"Default with shadow"})]})}),e.jsx(o,{variant:"outlined",children:e.jsxs(d,{children:[e.jsx(r,{weight:"medium",children:"Outlined"}),e.jsx(r,{size:"sm",color:"secondary",children:"With visible border"})]})}),e.jsx(o,{variant:"filled",children:e.jsxs(d,{children:[e.jsx(r,{weight:"medium",children:"Filled"}),e.jsx(r,{size:"sm",color:"secondary",children:"Different background"})]})})]})}),e.jsx(Qe,{title:"Complete Card Structure",children:e.jsxs(o,{variant:"outlined",style:{maxWidth:"400px"},children:[e.jsx(T,{children:e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:[e.jsx(r,{as:"h3",size:"lg",weight:"semibold",children:"Product Card"}),e.jsx(p,{variant:"success",children:"New"})]})}),e.jsxs(d,{children:[e.jsx(O,{src:"https://picsum.photos/300/150?random=1",alt:"Product image",variant:"default",shape:"rounded",style:{width:"100%",height:"150px",marginBottom:"var(--space-md)"}}),e.jsx(r,{style:{marginBottom:"var(--space-sm)"},children:"This is a complete card example showing how header, body, and footer work together."}),e.jsx(r,{size:"sm",color:"secondary",children:"Perfect for product listings, user profiles, or content previews."})]}),e.jsx(_e,{children:e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:[e.jsx(r,{weight:"semibold",color:"accent",children:"$99.99"}),e.jsx(j,{variant:"primary",size:"sm",children:"Add to Cart"})]})})]})}),e.jsx(Qe,{title:"Interactive Cards",children:e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(250px, 1fr))",gap:"var(--space-md)"},children:[e.jsx(o,{variant:"elevated",hoverable:!0,style:{cursor:"pointer"},onClick:()=>alert("Card clicked!"),children:e.jsxs(d,{children:[e.jsx(r,{as:"h4",weight:"semibold",style:{marginBottom:"var(--space-sm)"},children:"Clickable Card"}),e.jsx(r,{size:"sm",children:"This entire card is clickable and has hover effects."})]})}),e.jsxs(o,{variant:"outlined",children:[e.jsx(T,{children:e.jsx(r,{as:"h4",weight:"semibold",children:"User Profile"})}),e.jsx(d,{children:e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"var(--space-md)"},children:[e.jsx(O,{src:"https://picsum.photos/50/50?random=2",alt:"User avatar",shape:"circle",variant:"bordered",width:50,height:50}),e.jsxs("div",{children:[e.jsx(r,{weight:"medium",children:"Jane Smith"}),e.jsx(r,{size:"sm",color:"secondary",children:"UI/UX Designer"})]})]})}),e.jsx(_e,{children:e.jsxs("div",{style:{display:"flex",gap:"var(--space-sm)"},children:[e.jsx(j,{variant:"primary",size:"sm",children:"Follow"}),e.jsx(j,{variant:"secondary",size:"sm",children:"Message"})]})})]})]})})]})}),e.jsx(o,{style:{marginBottom:"var(--space-xl)"},children:e.jsxs(d,{children:[e.jsx(r,{as:"h2",size:"xl",weight:"semibold",style:{marginBottom:"var(--space-md)"},children:"API Reference"}),e.jsx(r,{as:"h3",size:"lg",weight:"medium",style:{marginBottom:"var(--space-sm)"},children:"Card Props"}),e.jsx("div",{style:{overflowX:"auto",marginBottom:"var(--space-lg)"},children:e.jsxs("table",{style:{width:"100%",borderCollapse:"collapse",backgroundColor:"var(--bg-elevated)",borderRadius:"var(--radius-md)",overflow:"hidden"},children:[e.jsx("thead",{children:e.jsxs("tr",{style:{backgroundColor:"var(--bg-surface)"},children:[e.jsx("th",{style:{padding:"var(--space-md)",textAlign:"left",borderBottom:"1px solid var(--border-color)",fontWeight:"var(--font-weight-semibold)"},children:"Prop"}),e.jsx("th",{style:{padding:"var(--space-md)",textAlign:"left",borderBottom:"1px solid var(--border-color)",fontWeight:"var(--font-weight-semibold)"},children:"Type"}),e.jsx("th",{style:{padding:"var(--space-md)",textAlign:"left",borderBottom:"1px solid var(--border-color)",fontWeight:"var(--font-weight-semibold)"},children:"Default"}),e.jsx("th",{style:{padding:"var(--space-md)",textAlign:"left",borderBottom:"1px solid var(--border-color)",fontWeight:"var(--font-weight-semibold)"},children:"Description"})]})}),e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"variant"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"'elevated' | 'outlined' | 'filled'"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"'elevated'"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"'default'"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:"Visual style variant affecting borders and shadows"})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"hoverable"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"boolean"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"false"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:"Adds hover effects and cursor pointer for interactive cards"})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"padding"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"'none' | 'sm' | 'md' | 'lg'"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"'md'"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:"Internal padding of the card container"})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"radius"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"'none' | 'sm' | 'md' | 'lg'"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"'md'"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:"Border radius of the card corners"})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"shadow"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"'none' | 'sm' | 'md' | 'lg'"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"'md'"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:"Drop shadow intensity of the card"})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"children"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"React.ReactNode"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"undefined"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:"Content of the card (typically CardHeader, CardBody, CardFooter)"})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"className"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"string"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"undefined"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:"Additional CSS class names for custom styling"})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"var(--space-md)"},children:e.jsx("code",{children:"style"})}),e.jsx("td",{style:{padding:"var(--space-md)"},children:e.jsx("code",{children:"React.CSSProperties"})}),e.jsx("td",{style:{padding:"var(--space-md)"},children:e.jsx("code",{children:"undefined"})}),e.jsx("td",{style:{padding:"var(--space-md)"},children:"Inline styles for custom styling"})]})]})]})}),e.jsx(r,{as:"h3",size:"lg",weight:"medium",style:{marginBottom:"var(--space-sm)"},children:"CardHeader, CardBody, CardFooter Props"}),e.jsx(r,{as:"p",size:"md",style:{marginBottom:"var(--space-md)",lineHeight:"1.6"},children:"All card section components (CardHeader, CardBody, CardFooter) accept the same props:"}),e.jsx("div",{style:{overflowX:"auto"},children:e.jsxs("table",{style:{width:"100%",borderCollapse:"collapse",backgroundColor:"var(--bg-elevated)",borderRadius:"var(--radius-md)",overflow:"hidden"},children:[e.jsx("thead",{children:e.jsxs("tr",{style:{backgroundColor:"var(--bg-surface)"},children:[e.jsx("th",{style:{padding:"var(--space-md)",textAlign:"left",borderBottom:"1px solid var(--border-color)",fontWeight:"var(--font-weight-semibold)"},children:"Prop"}),e.jsx("th",{style:{padding:"var(--space-md)",textAlign:"left",borderBottom:"1px solid var(--border-color)",fontWeight:"var(--font-weight-semibold)"},children:"Type"}),e.jsx("th",{style:{padding:"var(--space-md)",textAlign:"left",borderBottom:"1px solid var(--border-color)",fontWeight:"var(--font-weight-semibold)"},children:"Default"}),e.jsx("th",{style:{padding:"var(--space-md)",textAlign:"left",borderBottom:"1px solid var(--border-color)",fontWeight:"var(--font-weight-semibold)"},children:"Description"})]})}),e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"children"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"React.ReactNode"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"undefined"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:"Content of the card section"})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"className"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"string"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:e.jsx("code",{children:"undefined"})}),e.jsx("td",{style:{padding:"var(--space-md)",borderBottom:"1px solid var(--border-color)"},children:"Additional CSS class names for custom styling"})]}),e.jsxs("tr",{children:[e.jsx("td",{style:{padding:"var(--space-md)"},children:e.jsx("code",{children:"style"})}),e.jsx("td",{style:{padding:"var(--space-md)"},children:e.jsx("code",{children:"React.CSSProperties"})}),e.jsx("td",{style:{padding:"var(--space-md)"},children:e.jsx("code",{children:"undefined"})}),e.jsx("td",{style:{padding:"var(--space-md)"},children:"Inline styles for custom styling"})]})]})]})})]})}),e.jsx(o,{style:{marginBottom:"var(--space-xl)"},children:e.jsxs(d,{children:[e.jsx(r,{as:"h2",size:"xl",weight:"semibold",style:{marginBottom:"var(--space-md)"},children:"Usage Examples"}),e.jsx(r,{as:"h3",size:"lg",weight:"medium",style:{marginBottom:"var(--space-sm)"},children:"Product Card"}),e.jsx(Ne,{children:`import { Card, CardHeader, CardBody, CardFooter, Text, Button, Image } from '@flowlabkit/ui';
...
}`})]})}),e.jsx(o,{style:{marginBottom:"var(--space-xl)"},children:e.jsxs(d,{children:[e.jsx(r,{as:"h2",size:"xl",weight:"semibold",style:{marginBottom:"var(--space-md)"},children:"useTheme Hook"}),e.jsx(r,{as:"p",size:"md",style:{marginBottom:"var(--space-md)",lineHeight:"1.6"},children:"Access and control theme state throughout your application:"}),e.jsx(le,{language:"tsx",children:`import { useTheme } from '@flowlabkit/ui';
...
}`})})]})]})}),e.jsx(o,{children:e.jsxs(d,{children:[e.jsx(r,{as:"h2",size:"xl",weight:"semibold",style:{marginBottom:"var(--space-md)"},children:"Advanced Usage"}),e.jsx(r,{as:"h3",size:"lg",weight:"medium",style:{marginBottom:"var(--space-sm)"},children:"Custom Theme Creation"}),e.jsx(le,{language:"tsx",children:`import { Theme, lightTheme } from '@flowlabkit/ui';
...
<Button mobileOptimized={false}>
  Standard Button
</Button>`})]})]}),e.jsxs(o,{style:{marginBottom:"var(--space-xl)"},children:[e.jsx(T,{children:e.jsx(r,{as:"h2",size:"xl",weight:"semibold",children:"Responsive Breakpoints"})}),e.jsxs(d,{children:[e.jsx(r,{as:"p",size:"md",style:{marginBottom:"var(--space-lg)",lineHeight:"1.6"},children:"Standard breakpoints designed for modern devices and usage patterns."}),e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(250px, 1fr))",gap:"var(--space-md)",marginBottom:"var(--space-lg)"},children:[e.jsx(o,{children:e.jsxs(d,{children:[e.jsx(r,{weight:"semibold",children:"XS - Mobile Portrait"}),e.jsx(r,{size:"sm",color:"secondary",children:"320px+ • Phones in portrait"})]})}),e.jsx(o,{children:e.jsxs(d,{children:[e.jsx(r,{weight:"semibold",children:"SM - Mobile Landscape"}),e.jsx(r,{size:"sm",color:"secondary",children:"480px+ • Phones in landscape"})]})}),e.jsx(o,{children:e.jsxs(d,{children:[e.jsx(r,{weight:"semibold",children:"MD - Tablet"}),e.jsx(r,{size:"sm",color:"secondary",children:"768px+ • Tablets and small laptops"})]})}),e.jsx(o,{children:e.jsxs(d,{children:[e.jsx(r,{weight:"semibold",children:"LG - Desktop"}),e.jsx(r,{size:"sm",color:"secondary",children:"1024px+ • Laptops and desktops"})]})}),e.jsx(o,{children:e.jsxs(d,{children:[e.jsx(r,{weight:"semibold",children:"XL - Large Desktop"}),e.jsx(r,{size:"sm",color:"secondary",children:"1200px+ • Large screens"})]})}),e.jsx(o,{children:e.jsxs(d,{children:[e.jsx(r,{weight:"semibold",children:"XXL - Extra Large"}),e.jsx(r,{size:"sm",color:"secondary",children:"1400px+ • Ultra-wide displays"})]})})]}),e.jsx(r,{as:"h3",size:"lg",weight:"medium",style:{marginBottom:"var(--space-sm)",marginTop:"var(--space-lg)"},children:"CSS Variables"}),e.jsx(dr,{children:`/* Available breakpoint variables */
--breakpoint-xs: 320px;
--breakpoint-sm: 480px;
--breakpoint-md: 768px;
...
/>`}),e.jsx("div",{style:{marginBottom:"var(--space-md)",color:"var(--text-secondary)"},children:"// Legacy components still work"}),e.jsx("div",{children:`<TwoPanelLayout
  ...
  leftWidth="250px"
  gap="8px"
/>`})]})})]}),e.jsxs(o,{style:{marginBottom:"var(--space-lg)"},children:[e.jsxs(T,{children:[e.jsx(r,{as:"h2",size:"xl",children:"New Unified API vs Legacy"}),e.jsx(r,{size:"sm",style:{color:"var(--text-secondary)"},children:"The new Layout component provides a unified API while maintaining backward compatibility"})]}),e.jsx(d,{children:e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(400px, 1fr))",gap:"var(--space-lg)"},children:[e.jsxs("div",{children:[e.jsx(r,{as:"h3",size:"lg",style:{marginBottom:"var(--space-md)",color:"var(--accent-600)"},children:"New Unified API"}),e.jsx("div",{style:{backgroundColor:"var(--bg-elevated)",padding:"var(--space-md)",borderRadius:"var(--radius-md)",fontFamily:"Monaco, Consolas, monospace",fontSize:"12px",marginBottom:"var(--space-md)"},children:`// Three-panel layout
<Layout
  direction="horizontal"
  panels={[
...
/>`}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"var(--space-xs)"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"var(--space-xs)"},children:[e.jsx(p,{variant:"success",size:"sm",children:"[✓]"}),e.jsx(r,{size:"sm",children:"One component for all layouts"})]}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"var(--space-xs)"},children:[e.jsx(p,{variant:"success",size:"sm",children:"[✓]"}),e.jsx(r,{size:"sm",children:"Any number of panels"})]}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"var(--space-xs)"},children:[e.jsx(p,{variant:"success",size:"sm",children:"[✓]"}),e.jsx(r,{size:"sm",children:"Easy nesting"})]}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"var(--space-xs)"},children:[e.jsx(p,{variant:"success",size:"sm",children:"[✓]"}),e.jsx(r,{size:"sm",children:"Consistent API"})]})]})]}),e.jsxs("div",{children:[e.jsx(r,{as:"h3",size:"lg",style:{marginBottom:"var(--space-md)",color:"var(--text-secondary)"},children:"Legacy API (Still Supported)"}),e.jsx("div",{style:{backgroundColor:"var(--bg-elevated)",padding:"var(--space-md)",borderRadius:"var(--radius-md)",fontFamily:"Monaco, Consolas, monospace",fontSize:"12px",marginBottom:"var(--space-md)"},children:`// Three-panel layout
<ThreePanelLayout
  leftPanel={<Left />}
  centerPanel={<Center />}
  rightPanel={<Right />}
...
<DashboardLayout
  ...
  headerHeight="60px"
  sidebarWidth="250px"
/>`}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"var(--space-xs)"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"var(--space-xs)"},children:[e.jsx(p,{variant:"info",size:"sm",children:"[✓]"}),e.jsx(r,{size:"sm",children:"Familiar component names"})]}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"var(--space-xs)"},children:[e.jsx(p,{variant:"info",size:"sm",children:"[✓]"}),e.jsx(r,{size:"sm",children:"Backward compatible"})]}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"var(--space-xs)"},children:[e.jsx(p,{variant:"warning",size:"sm",children:"-"}),e.jsx(r,{size:"sm",children:"Separate components"})]}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"var(--space-xs)"},children:[e.jsx(p,{variant:"warning",size:"sm",children:"-"}),e.jsx(r,{size:"sm",children:"Fixed panel count"})]})]})]})]})})]}),e.jsxs(o,{style:{marginBottom:"var(--space-lg)"},children:[e.jsxs(T,{children:[e.jsx(r,{as:"h2",size:"xl",children:"Interactive Examples"}),e.jsx(r,{size:"sm",style:{color:"var(--text-secondary)"},children:"Simple, grid-based layouts that are easy to use and customize. All layouts are responsive and theme-aware."})]}),e.jsxs(d,{children:[e.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(200px, 1fr))",gap:"var(--space-sm)",marginBottom:"var(--space-md)"},children:f.map(E=>e.jsx(j,{variant:s===E.id?"primary":"ghost",onClick:()=>a(E.id),children:e.jsxs("div",{children:[e.jsx("div",{style:{fontWeight:"var(--font-weight-semibold)",marginBottom:"var(--space-xs)"},children:E.name}),e.jsx("div",{style:{fontSize:"var(--font-size-sm)",opacity:.9},children:E.description})]})},E.id))}),e.jsx("div",{style:{marginBottom:"var(--space-md)"},children:e.jsx(j,{variant:i?"primary":"outline",size:"sm",onClick:()=>n(!i),children:i?"Hide Code Examples":"Show Code Examples"})}),e.jsxs("div",{style:{marginTop:"var(--space-md)"},children:[e.jsx(r,{as:"h3",size:"lg",style:{marginBottom:"var(--space-sm)"},children:f.find(E=>E.id===s)?.name}),u(),A()]})]})]}),e.jsxs(o,{style:{marginBottom:"var(--space-lg)"},children:[e.jsxs(T,{children:[e.jsx(r,{as:"h2",size:"xl",children:"Available Layout Components"}),e.jsx(r,{size:"sm",style:{color:"var(--text-secondary)"},children:"Ready-to-use layout components for common application patterns."})]}),e.jsx(d,{children:e.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fill, minmax(250px, 1fr))",gap:"var(--space-md)"},children:Object.entries(fs).map(([E,x])=>e.jsxs("div",{style:{padding:"var(--space-md)",backgroundColor:"var(--bg-elevated)",border:"1px solid var(--border-color)",borderRadius:"var(--radius-md)"},children:[e.jsx("div",{style:{fontWeight:"var(--font-weight-semibold)",marginBottom:"var(--space-xs)",color:"var(--text-primary)"},children:x.name}),e.jsx("div",{style:{fontSize:"var(--font-size-sm)",color:"var(--text-secondary)",marginBottom:"var(--space-sm)"},children:x.description}),e.jsx(p,{variant:"secondary",size:"sm",children:x.direction})]},E))})})]}),e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(300px, 1fr))",gap:"var(--space-md)",marginBottom:"var(--space-lg)"},children:[e.jsxs(o,{children:[e.jsx(T,{children:e.jsx(r,{as:"h3",size:"lg",children:" Unified API"})}),e.jsxs(d,{children:[e.jsx(r,{size:"sm",style:{marginBottom:"var(--space-md)"},children:"New Layout component unifies all layout needs with direction + panels array. Clean, intuitive, and infinitely flexible."}),e.jsx("div",{style:{backgroundColor:"var(--bg-elevated)",padding:"var(--space-md)",borderRadius:"var(--radius-md)",fontFamily:"Monaco, Consolas, monospace",fontSize:"12px",color:"var(--text-secondary)"},children:`<Layout
  direction="horizontal"
  panels={[
    { children: <Sidebar />, width: '250px' },
    { children: <Main />, width: '1fr' }
  ]}
/>`})]})]}),e.jsxs(o,{children:[e.jsx(T,{children:e.jsx(r,{as:"h3",size:"lg",children:" Grid-Based"})}),e.jsxs(d,{children:[e.jsx(r,{size:"sm",style:{marginBottom:"var(--space-md)"},children:"Built on CSS Grid for reliable, predictable layouts that work consistently across browsers."}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"var(--space-sm)"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"var(--space-xs)"},children:[e.jsx(p,{variant:"success",size:"sm",children:"[✓]"}),e.jsx(r,{size:"sm",children:"Predictable sizing"})]}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"var(--space-xs)"},children:[e.jsx(p,{variant:"success",size:"sm",children:"[✓]"}),e.jsx(r,{size:"sm",children:"No layout bugs"})]}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"var(--space-xs)"},children:[e.jsx(p,{variant:"success",size:"sm",children:"[✓]"}),e.jsx(r,{size:"sm",children:"Responsive by default"})]})]})]})]}),e.jsxs(o,{children:[e.jsx(T,{children:e.jsx(r,{as:"h3",size:"lg",children:" Lightweight"})}),e.jsxs(d,{children:[e.jsx(r,{size:"sm",style:{marginBottom:"var(--space-md)"},children:"Zero dependencies, minimal JavaScript. Just simple React components with clean CSS Grid layouts."}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"var(--space-sm)"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"var(--space-xs)"},children:[e.jsx(p,{variant:"info",size:"sm"}),e.jsx(r,{size:"sm",children:"Fast rendering"})]}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"var(--space-xs)"},children:[e.jsx(p,{variant:"info",size:"sm"}),e.jsx(r,{size:"sm",children:"Small bundle size"})]}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"var(--space-xs)"},children:[e.jsx(p,{variant:"info",size:"sm",children:"🛠️"}),e.jsx(r,{size:"sm",children:"Easy to customize"})]})]})]})]})]}),e.jsxs(o,{children:[e.jsx(T,{children:e.jsx(r,{as:"h2",size:"xl",children:"API Reference"})}),e.jsx(d,{children:e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"var(--space-lg)"},children:[e.jsxs("div",{children:[e.jsx(r,{as:"h3",size:"lg",style:{marginBottom:"var(--space-md)"},children:"Layout (Unified API) "}),e.jsx("div",{style:{backgroundColor:"var(--bg-elevated)",padding:"var(--space-md)",borderRadius:"var(--radius-md)",fontFamily:"Monaco, Consolas, monospace",fontSize:"12px",marginBottom:"var(--space-md)"},children:`interface LayoutProps {
...
`,Lr=document.createElement("style");Lr.textContent=Js;document.head.appendChild(Lr);const Zs=os.createRoot(document.getElementById("root"));Zs.render(e.jsx(be.StrictMode,{children:e.jsx(_s,{})}));
